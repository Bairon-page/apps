...
.method public onActivityResult(IILandroid/content/Intent;)Z
    ...
    .line 156
    const-string/jumbo v1, "CordovaInterfaceImpl"

    const-string/jumbo v2, "Sending activity result to plugin"
    ...
    .line 162
    :cond_1
    const-string/jumbo v2, "CordovaInterfaceImpl"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "Got an activity result, but no plugin was registered to receive it"
...
.method public onCordovaInit(Lorg/apache/cordova/PluginManager;)V
    ...
    .line 121
    const-string/jumbo v3, "CoreAndroid"
    ...
    const-string/jumbo v3, "CordovaInterfaceImpl"

    const-string/jumbo v4, "Failed to create event message"
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v1, "callbackService"
