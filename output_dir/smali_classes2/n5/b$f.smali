...
.method constructor <init>(Ln5/b;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, v0, Ln5/b$f;->a:Ln5/b;
...
.method protected bridge synthetic bind(Lg2/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p1, p2}, Ln5/b$f;->e(Lg2/k;Lcom/getmimo/data/model/room/LessonProgress;)V
...
.method protected createQuery()Ljava/lang/String;
    ...
    const-string v3, "UPDATE `lesson_progress` SET `lesson_id` = ?,`completed_at` = ?,`started_at` = ?,`tries` = ?,`tutorial_id` = ?,`tutorial_version` = ?,`track_id` = ?,`publish_set_version` = ?,`attempts` = ?,`is_practice_progress` = ?,`in_queue` = ? WHERE `lesson_id` = ? AND `tutorial_id` = ?"
...
.method protected e(Lg2/k;Lcom/getmimo/data/model/room/LessonProgress;)V
    .locals 7
