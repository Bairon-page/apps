.class public final Lcom/getmimo/analytics/Analytics$L;
...
.method public constructor <init>(JLcom/getmimo/analytics/properties/LessonType;JILjava/lang/Integer;JIIZLcom/getmimo/analytics/properties/lesson/ExitLessonPopupShownSource;)V
    ...
    const-string v0, "exitLessonPopupShownSource"

    invoke-static {p13, v0}, Lkotlin/jvm/internal/o;->g(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v0, Lr4/a$M;

    invoke-direct {v0}, Lr4/a$M;-><init>()V
    ...
    invoke-direct {p5, p8, p6}, Lcom/getmimo/analytics/properties/base/NumberProperty;-><init>(Ljava/lang/String;Ljava/lang/Number;)V
    ...
    invoke-direct {p6, p9, p8}, Lcom/getmimo/analytics/properties/base/NumberProperty;-><init>(Ljava/lang/String;Ljava/lang/Number;)V

    new-instance p8, Lcom/getmimo/analytics/properties/base/BooleanProperty;

    const-string p9, "exit"

    invoke-direct {p8, p9, p12}, Lcom/getmimo/analytics/properties/base/BooleanProperty;-><init>(Ljava/lang/String;Z)V

    const/16 p9, 0x32b4

    const/16 p9, 0x9

    new-array p9, p9, [Lcom/getmimo/analytics/properties/base/BaseProperty;

    const/4 p10, 0x2

    const/4 p10, 0x0

    aput-object v1, p9, p10

    const/4 p10, 0x6

    const/4 p10, 0x1

    aput-object p3, p9, p10
    ...
    aput-object p13, p9, p1

    invoke-static {p9}, Lkotlin/collections/k;->o([Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    check-cast p1, Ljava/util/Collection;

    invoke-static {p7}, Ln4/e;->a(Ljava/lang/Object;)Ljava/util/List;
