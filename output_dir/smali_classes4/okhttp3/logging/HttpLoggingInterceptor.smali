...
.method private final b(Lokhttp3/Headers;)Z
    ...
    invoke-static {p1, v1, v2}, Lkotlin/text/g;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final d(Lokhttp3/Headers;I)V
    ...
    :cond_0
    invoke-virtual {p1, p2}, Lokhttp3/Headers;->p(I)Ljava/lang/String;
...
.method public a(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-interface/range {p1 .. p1}, Lokhttp3/Interceptor$Chain;->f()Lokhttp3/Request;
    ...
    invoke-interface/range {p1 .. p1}, Lokhttp3/Interceptor$Chain;->a()Lokhttp3/Connection;
    ...
    invoke-virtual {v7, v6}, Lokhttp3/RequestBody;->g(LSh/e;)V
    ...
    invoke-static {v6}, Lokhttp3/logging/Utf8Kt;->a(LSh/d;)Z
    ...
    invoke-virtual {v3}, Lokhttp3/ResponseBody;->f()J
    ...
    invoke-virtual {v0}, Lokhttp3/Response;->s1()Lokhttp3/Request;
    ...
    invoke-virtual {v0}, Lokhttp3/Response;->f0()Lokhttp3/Headers;
    ...
    :cond_18
    invoke-virtual {v3}, Lokhttp3/ResponseBody;->C()LSh/f;

    move-result-object v4

    const-wide v5, 0x7fffffffffffffffL

    invoke-interface {v4, v5, v6}, LSh/f;->o(J)Z

    invoke-interface {v4}, LSh/f;->i()LSh/d;
    ...
    invoke-static {v5, v2, v6}, Lkotlin/text/g;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4}, LSh/d;->f0()LSh/d;

    move-result-object v4

    invoke-direct {v5, v4}, LSh/o;-><init>(LSh/H;)V
    ...
    invoke-virtual {v4, v5}, LSh/d;->b1(LSh/H;)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    const/4 v6, 0x0

    invoke-static {v5, v6}, LWf/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v5, v2}, LWf/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :goto_d
    invoke-virtual {v3}, Lokhttp3/ResponseBody;->t()Lokhttp3/MediaType;
    ...
    :cond_1b
    invoke-static {v4}, Lokhttp3/logging/Utf8Kt;->a(LSh/d;)Z
    ...
    invoke-virtual {v6, v5}, LSh/d;->W0(Ljava/nio/charset/Charset;)Ljava/lang/String;
