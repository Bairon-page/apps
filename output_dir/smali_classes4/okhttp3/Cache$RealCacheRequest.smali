...
.method public constructor <init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p2, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->f(I)LSh/F;

    move-result-object p2

    iput-object p2, p0, Lokhttp3/Cache$RealCacheRequest;->b:LSh/F;

    new-instance v0, Lokhttp3/Cache$RealCacheRequest$1;

    invoke-direct {v0, p1, p0, p2}, Lokhttp3/Cache$RealCacheRequest$1;-><init>(Lokhttp3/Cache;Lokhttp3/Cache$RealCacheRequest;LSh/F;)V

    iput-object v0, p0, Lokhttp3/Cache$RealCacheRequest;->c:LSh/F;
...
.method public a()V
    ...
    invoke-virtual {v0}, Lokhttp3/Cache;->f()I

    move-result v2

    add-int/2addr v2, v1

    invoke-virtual {v0, v2}, Lokhttp3/Cache;->K(I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    monitor-exit v0

    iget-object v0, p0, Lokhttp3/Cache$RealCacheRequest;->b:LSh/F;
...
.method public b()LSh/F;
    .locals 1

    iget-object v0, p0, Lokhttp3/Cache$RealCacheRequest;->c:LSh/F;
