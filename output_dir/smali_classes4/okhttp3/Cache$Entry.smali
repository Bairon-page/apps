...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "c",
        "(LSh/f;)Ljava/util/List;",
        "LSh/e;",
        "sink",
        "certificates",
        "LNf/u;",
        "e",
        "(LSh/e;Ljava/util/List;)V",
...
.method public constructor <init>(LSh/H;)V
    ...
    sget-object v2, Lokhttp3/Cache;->v:Lokhttp3/Cache$Companion;

    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->c(LSh/f;)I
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->c(LSh/f;)Ljava/util/List;
    ...
    :cond_4
    sget-object v0, Lokhttp3/TlsVersion;->v:Lokhttp3/TlsVersion;
    ...
    invoke-static {p1, v2}, LWf/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public constructor <init>(Lokhttp3/Response;)V
    ...
    invoke-virtual {p1}, Lokhttp3/Response;->T0()Lokhttp3/Protocol;
...
.method private final c(LSh/f;)Ljava/util/List;
    .locals 7

    sget-object v0, Lokhttp3/Cache;->v:Lokhttp3/Cache$Companion;

    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->c(LSh/f;)I
    ...
    invoke-virtual {v5, v4}, LSh/d;->I1(Lokio/ByteString;)LSh/d;

    invoke-virtual {v5}, LSh/d;->q1()Ljava/io/InputStream;
...
.method private final e(LSh/e;Ljava/util/List;)V
    .locals 8
    ...
    invoke-static/range {v2 .. v7}, Lokio/ByteString$a;->g(Lokio/ByteString$a;[BIIILjava/lang/Object;)Lokio/ByteString;
...
.method public final d(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/Request$Builder;->k(Lokhttp3/HttpUrl;)Lokhttp3/Request$Builder;
    ...
    invoke-virtual {v2, v3, v4}, Lokhttp3/Request$Builder;->f(Ljava/lang/String;Lokhttp3/RequestBody;)Lokhttp3/Request$Builder;

    move-result-object v2

    iget-object v3, p0, Lokhttp3/Cache$Entry;->b:Lokhttp3/Headers;

    invoke-virtual {v2, v3}, Lokhttp3/Request$Builder;->e(Lokhttp3/Headers;)Lokhttp3/Request$Builder;
...
.method public final f(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->f(I)LSh/F;
    ...
    invoke-interface {p1, v3, v4}, LSh/e;->u0(J)LSh/e;
    ...
    invoke-interface {p1, v5}, LSh/e;->W(Ljava/lang/String;)LSh/e;

    move-result-object v5

    invoke-interface {v5, v4}, LSh/e;->W(Ljava/lang/String;)LSh/e;

    move-result-object v4

    iget-object v5, p0, Lokhttp3/Cache$Entry;->b:Lokhttp3/Headers;

    invoke-virtual {v5, v3}, Lokhttp3/Headers;->p(I)Ljava/lang/String;
    ...
    invoke-interface {v4, v2}, LSh/e;->I0(I)LSh/e;
    ...
    invoke-interface {p1, v5, v6}, LSh/e;->u0(J)LSh/e;
    ...
    invoke-virtual {v5, v0}, Lokhttp3/Headers;->p(I)Ljava/lang/String;

    move-result-object v5

    invoke-interface {v3, v5}, LSh/e;->W(Ljava/lang/String;)LSh/e;

    move-result-object v3

    invoke-interface {v3, v2}, LSh/e;->I0(I)LSh/e;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->e(LSh/e;Ljava/util/List;)V
