...
.field private final d:LSh/d;

.field private e:Lokhttp3/Headers;

.field private f:Z

.field final synthetic v:Lokhttp3/internal/http2/Http2Stream;
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->v:Lokhttp3/internal/http2/Http2Stream;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->c:LSh/d;

    new-instance p1, LSh/d;

    invoke-direct {p1}, LSh/d;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;
...
.method private final C(J)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->v:Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-virtual {v0, p1, p2}, Lokhttp3/internal/http2/Http2Connection;->W1(J)V
...
.method public close()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;

    invoke-virtual {v1}, LSh/d;->E1()J

    move-result-wide v1

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;

    invoke-virtual {v3}, LSh/d;->e0()V
    ...
    invoke-direct {p0, v1, v2}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->C(J)V
...
.method public final f(LSh/f;J)V
    .locals 11
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->v:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v6, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->v:Lokhttp3/internal/http2/Http2Stream;
    ...
    :cond_4
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->c:LSh/d;

    invoke-interface {p1, v4, v0, v1}, LSh/H;->w0(LSh/d;J)J
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->c:LSh/d;

    invoke-virtual {v2}, LSh/d;->e0()V
    ...
    :cond_5
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;
    ...
    :cond_6
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->c:LSh/d;

    invoke-virtual {v2, v3}, LSh/d;->b1(LSh/H;)J
    ...
    :cond_9
    invoke-direct {p0, p2, p3}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->C(J)V
...
.method public final w(Lokhttp3/Headers;)V
    .locals 0
...
.method public w0(LSh/d;J)J
    ...
    :goto_0
    iget-object v6, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->v:Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v8, v1, Lokhttp3/internal/http2/Http2Stream$FramingSource;->d:LSh/d;
    ...
    invoke-virtual {v8, v0, v12, v13}, LSh/d;->w0(LSh/d;J)J
    ...
    invoke-virtual {v8}, Lokhttp3/internal/http2/Http2Connection;->B1()Lokhttp3/internal/http2/Settings;
    ...
    invoke-virtual {v4, v5, v14, v15}, Lokhttp3/internal/http2/Http2Connection;->c2(IJ)V
