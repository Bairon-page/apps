...
.method public constructor <init>(LSh/f;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(LSh/f;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LSh/H;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final C(IIII)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->t(I)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->w(I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->c:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-virtual {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->C(I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->c:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-virtual {p1, p3}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->f(I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->c:Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-virtual {p1, p4}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->K(I)V
...
.method private final F0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lfg/j;->t(II)Lfg/i;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lfg/j;->s(Lfg/g;I)Lfg/g;
    ...
    :cond_3
    :goto_0
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;

    invoke-interface {v3}, LSh/f;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
...
.method private final K(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
    ...
    invoke-direct {p0, p1, p4}, Lokhttp3/internal/http2/Http2Reader;->e0(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->i(ZIILjava/util/List;)V
...
.method private final L0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    .locals 2
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
    ...
    invoke-interface {p1, p4, p2, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->b(IJ)V
...
.method private final M(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
    ...
    :goto_0
    invoke-interface {p1, v0, p2, p4}, Lokhttp3/internal/http2/Http2Reader$Handler;->c(ZII)V
...
.method private final e0(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    .locals 5

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
    ...
    invoke-interface {p1, p2, v0, v3, v1}, Lokhttp3/internal/http2/Http2Reader$Handler;->h(IIIZ)V
...
.method private final k0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    .locals 3
...
.method private final m0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    .locals 0
...
.method private final t(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->n(ZILSh/f;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:LSh/f;
...
.method private final w(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->m(ILokhttp3/internal/http2/ErrorCode;Lokio/ByteString;)V
...
.method public final d(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    .locals 11
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->K(LSh/f;)I
    ...
    :pswitch_0
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->L0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    :pswitch_3
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->k0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    :pswitch_4
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->F0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V

    goto :goto_1

    :pswitch_5
    invoke-direct {p0, p2, v0, v8, v9}, Lokhttp3/internal/http2/Http2Reader;->m0(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
...
.method public final f(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    .locals 4
    ...
    invoke-virtual {p0, v0, p1}, Lokhttp3/internal/http2/Http2Reader;->d(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {p1, v1, v2}, LSh/f;->z0(J)Lokio/ByteString;
    ...
    invoke-virtual {p1}, Lokio/ByteString;->f0()Ljava/lang/String;
