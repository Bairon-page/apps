...
.method public static final a(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v3, v4}, Lkotlin/text/g;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v3, v4}, LSh/d;->T1(Ljava/lang/String;)LSh/d;

    move-result-object v3

    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/HttpHeaders;->c(LSh/d;Ljava/util/List;)V
    :try_end_0
...
.method public static final b(Lokhttp3/Response;)Z
    ...
    invoke-static {p0, v0, v4, v2, v4}, Lokhttp3/Response;->e0(Lokhttp3/Response;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;

    move-result-object p0

    const-string v0, "chunked"

    invoke-static {v0, p0, v3}, Lkotlin/text/g;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final c(LSh/d;Ljava/util/List;)V
    .locals 7
    ...
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->g(LSh/d;)Z

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->e(LSh/d;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->L(LSh/d;B)I
    ...
    invoke-static {v3, v5}, Lkotlin/text/g;->F(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    invoke-static {p0, v6}, Lokhttp3/internal/http/HttpHeaders;->h(LSh/d;B)Z

    move-result v6

    if-eqz v6, :cond_8

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->d(LSh/d;)Ljava/lang/String;
...
.method private static final d(LSh/d;)Ljava/lang/String;
    .locals 12
    ...
    invoke-virtual {p0, v2}, LSh/d;->P(Lokio/ByteString;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, LSh/d;->K0(LSh/d;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, LSh/d;->K0(LSh/d;J)V
...
.method private static final e(LSh/d;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->b:Lokio/ByteString;

    invoke-virtual {p0, v0}, LSh/d;->P(Lokio/ByteString;)J
    ...
    invoke-virtual {p0, v0, v1}, LSh/d;->x0(J)Ljava/lang/String;
...
.method private static final g(LSh/d;)Z
    .locals 3
...
.method private static final h(LSh/d;B)Z
    .locals 2
