...
# instance fields
.field private B:Lbh/v;

.field private final C:Lpg/G;


# direct methods
.method public constructor <init>(Lpg/F;Lqg/e;Lkotlin/reflect/jvm/internal/impl/descriptors/Modality;Lpg/o;ZZZLkotlin/reflect/jvm/internal/impl/descriptors/CallableMemberDescriptor$Kind;Lpg/G;Lpg/J;)V
    .locals 12
    ...
    :goto_0
    iput-object v0, v1, Lsg/y;->C:Lpg/G;
...
.method public bridge synthetic F0()Lpg/j;
    ...
    invoke-virtual {p0}, Lsg/y;->O0()Lpg/G;
...
.method public O0()Lpg/G;
    .locals 2

    iget-object v0, p0, Lsg/y;->C:Lpg/G;

    if-nez v0, :cond_0

    const/16 v1, 0x8

    invoke-static {v1}, Lsg/y;->z(I)V

    :cond_0
    return-object v0
.end method

.method public P0(Lbh/v;)V
    .locals 0
    ...
    :cond_0
    iput-object p1, p0, Lsg/y;->B:Lbh/v;
...
.method public b0(Lpg/i;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, p2}, Lpg/i;->c(Lpg/G;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getReturnType()Lbh/v;
    ...
    iget-object v0, p0, Lsg/y;->B:Lbh/v;
