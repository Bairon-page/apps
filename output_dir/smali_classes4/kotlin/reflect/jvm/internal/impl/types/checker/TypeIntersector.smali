...
.method public static final synthetic a(Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector;Lbh/v;Lbh/v;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector;->e(Lbh/v;Lbh/v;)Z
...
.method private final b(Ljava/util/Collection;LZf/p;)Ljava/util/Collection;
    .locals 5
    ...
    invoke-interface {p2, v3, v1}, LZf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private final d(Ljava/util/Set;)Lbh/z;
    .locals 3
    ...
    invoke-direct {p0, p1, v0}, Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector;->b(Ljava/util/Collection;LZf/p;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, v0}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/IntegerLiteralTypeConstructor$Companion;->b(Ljava/util/Collection;)Lbh/z;
    ...
    invoke-direct {p0, v0, v1}, Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector;->b(Ljava/util/Collection;LZf/p;)Ljava/util/Collection;
    ...
    invoke-static {v0}, Lkotlin/collections/k;->Q0(Ljava/lang/Iterable;)Ljava/lang/Object;
...
.method private final e(Lbh/v;Lbh/v;)Z
    .locals 2
    ...
    invoke-virtual {v0, p1, p2}, Lkotlin/reflect/jvm/internal/impl/types/checker/f;->c(Lbh/v;Lbh/v;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0, p2, p1}, Lkotlin/reflect/jvm/internal/impl/types/checker/f;->c(Lbh/v;Lbh/v;)Z
...
# virtual methods
.method public final c(Ljava/util/List;)Lbh/z;
    .locals 8
    ...
    invoke-interface {v5}, Lbh/I;->m()Ljava/util/Collection;
    ...
    invoke-static {v5, v4}, Lkotlin/collections/k;->w(Ljava/lang/Iterable;I)I
    ...
    invoke-virtual {v5, v3}, Lbh/z;->U0(Z)Lbh/z;
    ...
    invoke-virtual {v1, v5}, Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector$ResultNullability;->c(Lbh/Q;)Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector$ResultNullability;
    ...
    instance-of v6, v5, Lch/e;

    if-eqz v6, :cond_5

    check-cast v5, Lch/e;

    invoke-static {v5}, Lbh/B;->k(Lch/e;)Lch/e;
    ...
    invoke-static {v5, v6, v3, v7}, Lbh/B;->i(Lbh/z;ZILjava/lang/Object;)Lbh/z;
    ...
    invoke-virtual {v1}, Lbh/v;->M0()Lkotlin/reflect/jvm/internal/impl/types/n;
    ...
    invoke-virtual {v0, v1}, Lkotlin/reflect/jvm/internal/impl/types/n;->q(Lkotlin/reflect/jvm/internal/impl/types/n;)Lkotlin/reflect/jvm/internal/impl/types/n;
    ...
    invoke-direct {p0, v2}, Lkotlin/reflect/jvm/internal/impl/types/checker/TypeIntersector;->d(Ljava/util/Set;)Lbh/z;
