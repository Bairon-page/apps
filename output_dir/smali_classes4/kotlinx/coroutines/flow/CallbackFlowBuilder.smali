...
.method public constructor <init>(LZf/p;Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lkotlinx/coroutines/flow/b;-><init>(LZf/p;Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;)V

    iput-object p1, p0, Lkotlinx/coroutines/flow/CallbackFlowBuilder;->e:LZf/p;

    return-void
.end method

.method public synthetic constructor <init>(LZf/p;Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    :cond_2
    invoke-direct {p0, p1, p2, p3, p4}, Lkotlinx/coroutines/flow/CallbackFlowBuilder;-><init>(LZf/p;Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;)V
...
.method protected h(Lqh/f;LRf/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lkotlinx/coroutines/flow/CallbackFlowBuilder$collectTo$1;-><init>(Lkotlinx/coroutines/flow/CallbackFlowBuilder;LRf/c;)V
    ...
    invoke-super {p0, p1, v0}, Lkotlinx/coroutines/flow/b;->h(Lqh/f;LRf/c;)Ljava/lang/Object;
    ...
    :cond_3
    :goto_1
    invoke-interface {p1}, Lkotlinx/coroutines/channels/h;->k()Z
...
.method protected i(Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;)Lkotlinx/coroutines/flow/internal/ChannelFlow;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/flow/CallbackFlowBuilder;->e:LZf/p;

    invoke-direct {v0, v1, p1, p2, p3}, Lkotlinx/coroutines/flow/CallbackFlowBuilder;-><init>(LZf/p;Lkotlin/coroutines/d;ILkotlinx/coroutines/channels/BufferOverflow;)V
