...
.field public final f:Lwh/c;

.field private volatile synthetic parkedWorkersStack$volatile:J

.field public final v:Lth/x;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->A:Lth/C;
...
.method public constructor <init>(IIJLjava/lang/String;)V
    ...
    invoke-direct {p2}, Lwh/c;-><init>()V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lwh/c;

    new-instance p2, Lwh/c;

    invoke-direct {p2}, Lwh/c;-><init>()V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lwh/c;

    new-instance p2, Lth/x;

    add-int/lit8 p3, p1, 0x1

    mul-int/lit8 p3, p3, 0x2

    invoke-direct {p2, p3}, Lth/x;-><init>(I)V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;
...
.method private final A1()Z
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->L0()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
...
.method private final C()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
    .locals 3
...
.method private final F0(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
    .locals 1
    ...
    :goto_0
    sget-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->A:Lth/C;
...
.method private final L0()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
    .locals 10

    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->k0()Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    iget-object v2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v2, v1}, Lth/x;->b(I)Ljava/lang/Object;
    ...
    invoke-direct {p0, v7}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->F0(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
...
.method public static final synthetic a()Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    invoke-static {}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f0()Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
...
.method private final d(Lwh/g;)Z
    .locals 2
    ...
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lwh/c;

    invoke-virtual {v0, p1}, Lth/q;->a(Ljava/lang/Object;)Z
    ...
    :cond_0
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lwh/c;
...
.method public static synthetic e0(Lkotlinx/coroutines/scheduling/CoroutineScheduler;Ljava/lang/Runnable;Lwh/h;ZILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->K(Ljava/lang/Runnable;Lwh/h;Z)V
...
.method private final t()I
    ...
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;
    ...
    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v5, v2}, Lth/x;->b(I)Ljava/lang/Object;
    ...
    iget-object v6, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v6, v2, v5}, Lth/x;->c(ILjava/lang/Object;)V
...
.method private final v1(JZ)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->A1()Z
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->y1(J)Z
...
.method private final x1(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lwh/g;Z)Lwh/g;
    .locals 2
    ...
    :cond_1
    iget-object v0, p2, Lwh/g;->b:Lwh/h;
    ...
    iget-object p1, p1, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lwh/m;

    invoke-virtual {p1, p2, p3}, Lwh/m;->a(Lwh/g;Z)Lwh/g;
...
.method private final y1(J)Z
    ...
    invoke-static {v0, p1}, Lfg/j;->d(II)I
...
.method static synthetic z1(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
    .locals 0
...
# virtual methods
.method public final K(Ljava/lang/Runnable;Lwh/h;Z)V
    .locals 5

    invoke-static {}, Loh/b;->a()Loh/a;

    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->w(Ljava/lang/Runnable;Lwh/h;)Lwh/g;

    move-result-object p1

    iget-object p2, p1, Lwh/g;->b:Lwh/h;

    invoke-interface {p2}, Lwh/h;->b()I
    ...
    :goto_1
    invoke-direct {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->C()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;

    move-result-object v4

    invoke-direct {p0, v4, p1, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->x1(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lwh/g;Z)Lwh/g;

    move-result-object p1

    if-eqz p1, :cond_3

    invoke-direct {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->d(Lwh/g;)Z
    ...
    invoke-direct {p0, v2, v3, v0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v1(JZ)V
    ...
    :cond_6
    invoke-virtual {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->w1()V
...
.method public close()V
    ...
    invoke-virtual {p0, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->u1(J)V
...
.method public final n1(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)Z
    .locals 9
    ...
    iget-object v7, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v7, v1}, Lth/x;->b(I)Ljava/lang/Object;
...
.method public final s1(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;II)V
    .locals 9
    ...
    invoke-direct {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->F0(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
...
.method public final t1(Lwh/g;)V
    .locals 2
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v1}, Lth/x;->a()I
    ...
    iget-object v9, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v9, v8}, Lth/x;->b(I)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v10, v9, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lwh/m;

    invoke-virtual {v10}, Lwh/m;->i()I
...
.method public final u1(J)V
    ...
    :goto_0
    iget-object v4, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v:Lth/x;

    invoke-virtual {v4, v1}, Lth/x;->b(I)Ljava/lang/Object;
    ...
    :cond_1
    iget-object v4, v4, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lwh/m;

    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lwh/c;

    invoke-virtual {v4, v5}, Lwh/m;->j(Lwh/c;)V
    ...
    :cond_3
    iget-object p1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lwh/c;

    invoke-virtual {p1}, Lth/q;->b()V

    iget-object p1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lwh/c;
    ...
    invoke-virtual {v0, v2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->g(Z)Lwh/g;
    ...
    invoke-virtual {p1}, Lth/q;->e()Ljava/lang/Object;
    ...
    :cond_6
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->t1(Lwh/g;)V
...
.method public final w(Ljava/lang/Runnable;Lwh/h;)Lwh/g;
    .locals 3

    sget-object v0, Lwh/k;->f:Lwh/f;

    invoke-virtual {v0}, Lwh/f;->a()J

    move-result-wide v0

    instance-of v2, p1, Lwh/g;

    if-eqz v2, :cond_0

    check-cast p1, Lwh/g;

    iput-wide v0, p1, Lwh/g;->a:J

    iput-object p2, p1, Lwh/g;->b:Lwh/h;
    ...
    invoke-direct {v2, p1, v0, v1, p2}, Lwh/j;-><init>(Ljava/lang/Runnable;JLwh/h;)V
...
.method public final w1()V
    ...
    invoke-static {p0, v2, v3, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->z1(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
