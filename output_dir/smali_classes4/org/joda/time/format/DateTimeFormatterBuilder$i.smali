...
.method private b(JLorg/joda/time/a;Ljava/util/Locale;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$i;->a:Lorg/joda/time/DateTimeFieldType;

    invoke-virtual {v0, p3}, Lorg/joda/time/DateTimeFieldType;->F(Lorg/joda/time/a;)Lorg/joda/time/b;
...
.method private g(Lorg/joda/time/i;Ljava/util/Locale;)Ljava/lang/String;
    .locals 2
...
.method public a()I
    ...
    invoke-virtual {p0}, Lorg/joda/time/format/DateTimeFormatterBuilder$i;->e()I
...
.method public c(Lorg/joda/time/format/b;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lorg/joda/time/format/b;->o()Ljava/util/Locale;
    ...
    sget-object v7, Lorg/joda/time/DateTimeZone;->a:Lorg/joda/time/DateTimeZone;
    ...
    invoke-virtual {v4, v5}, Lorg/joda/time/MutableDateTime;->S(Lorg/joda/time/DateTimeFieldType;)Lorg/joda/time/MutableDateTime$Property;

    move-result-object v4

    invoke-virtual {v4}, Lorg/joda/time/field/AbstractReadableInstantFieldProperty;->l()I

    move-result v5

    invoke-virtual {v4}, Lorg/joda/time/field/AbstractReadableInstantFieldProperty;->i()I
    ...
    invoke-virtual {v4, v5}, Lorg/joda/time/MutableDateTime$Property;->n(I)Lorg/joda/time/MutableDateTime;
    ...
    invoke-virtual {p1, p2, v3, v0}, Lorg/joda/time/format/b;->w(Lorg/joda/time/DateTimeFieldType;Ljava/lang/String;Ljava/util/Locale;)V
...
.method public d(Ljava/lang/Appendable;Lorg/joda/time/i;Ljava/util/Locale;)V
    ...
    :try_start_0
    invoke-direct {p0, p2, p3}, Lorg/joda/time/format/DateTimeFormatterBuilder$i;->g(Lorg/joda/time/i;Ljava/util/Locale;)Ljava/lang/String;
...
.method public f(Ljava/lang/Appendable;JLorg/joda/time/a;ILorg/joda/time/DateTimeZone;Ljava/util/Locale;)V
    ...
    :try_start_0
    invoke-direct {p0, p2, p3, p4, p7}, Lorg/joda/time/format/DateTimeFormatterBuilder$i;->b(JLorg/joda/time/a;Ljava/util/Locale;)Ljava/lang/String;
