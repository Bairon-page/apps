...
.method private b(JLorg/joda/time/b;)[J
    .locals 6
    ...
    invoke-virtual {p3}, Lorg/joda/time/d;->j()J
...
.method public c(Lorg/joda/time/format/b;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lorg/joda/time/format/b;->n()Lorg/joda/time/a;
    ...
    invoke-virtual {v2}, Lorg/joda/time/d;->j()J
    ...
    sget-object v2, Lorg/joda/time/field/MillisDurationField;->a:Lorg/joda/time/d;

    invoke-virtual {v0}, Lorg/joda/time/b;->l()Lorg/joda/time/d;

    move-result-object v0

    invoke-direct {p2, v1, v2, v0}, Lorg/joda/time/field/f;-><init>(Lorg/joda/time/DateTimeFieldType;Lorg/joda/time/d;Lorg/joda/time/d;)V

    long-to-int v0, v6

    invoke-virtual {p1, p2, v0}, Lorg/joda/time/format/b;->u(Lorg/joda/time/b;I)V
...
.method public d(Ljava/lang/Appendable;Lorg/joda/time/i;Ljava/util/Locale;)V
    ...
    invoke-interface {p2}, Lorg/joda/time/i;->k()Lorg/joda/time/a;

    move-result-object p3

    const-wide/16 v0, 0x0

    invoke-virtual {p3, p2, v0, v1}, Lorg/joda/time/a;->I(Lorg/joda/time/i;J)J
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lorg/joda/time/format/DateTimeFormatterBuilder$d;->g(Ljava/lang/Appendable;JLorg/joda/time/a;)V
...
.method public f(Ljava/lang/Appendable;JLorg/joda/time/a;ILorg/joda/time/DateTimeZone;Ljava/util/Locale;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lorg/joda/time/format/DateTimeFormatterBuilder$d;->g(Ljava/lang/Appendable;JLorg/joda/time/a;)V

    return-void
.end method

.method protected g(Ljava/lang/Appendable;JLorg/joda/time/a;)V
    .locals 7

    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatterBuilder$d;->a:Lorg/joda/time/DateTimeFieldType;

    invoke-virtual {v0, p4}, Lorg/joda/time/DateTimeFieldType;->F(Lorg/joda/time/a;)Lorg/joda/time/b;
    ...
    :try_start_0
    invoke-virtual {p4, p2, p3}, Lorg/joda/time/b;->C(J)J
    ...
    :cond_1
    invoke-direct {p0, p2, p3, p4}, Lorg/joda/time/format/DateTimeFormatterBuilder$d;->b(JLorg/joda/time/b;)[J
