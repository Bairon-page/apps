...
.method private a0(Ljava/lang/Object;)Z
    ...
    instance-of v0, p1, Lorg/joda/time/format/h;
...
.method private e(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 1
...
.method public D(LAi/b;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 3

    invoke-direct {p0, p1}, Lorg/joda/time/format/DateTimeFormatterBuilder;->U(LAi/b;)V

    invoke-static {p1}, Lorg/joda/time/format/c;->d(LAi/b;)Lorg/joda/time/format/f;
    ...
    new-array v1, v1, [Lorg/joda/time/format/f;
    ...
    invoke-direct {p1, v1}, Lorg/joda/time/format/DateTimeFormatterBuilder$e;-><init>([Lorg/joda/time/format/f;)V

    invoke-direct {p0, v0, p1}, Lorg/joda/time/format/DateTimeFormatterBuilder;->e(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public I()Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {p0, v0, v0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->e(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public J()Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    invoke-direct {p0, v0, v2}, Lorg/joda/time/format/DateTimeFormatterBuilder;->e(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)Lorg/joda/time/format/DateTimeFormatterBuilder;
...
.method public a(LAi/b;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 1
...
.method public b(LAi/c;[LAi/b;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 5

    if-eqz p1, :cond_0

    invoke-direct {p0, p1}, Lorg/joda/time/format/DateTimeFormatterBuilder;->V(LAi/c;)V
    ...
    invoke-static {p1}, Lorg/joda/time/format/d;->a(LAi/c;)Lorg/joda/time/format/h;

    move-result-object p1

    aget-object p2, p2, v1

    invoke-static {p2}, Lorg/joda/time/format/c;->d(LAi/b;)Lorg/joda/time/format/f;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lorg/joda/time/format/DateTimeFormatterBuilder;->e(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    ...
    :cond_2
    new-array v3, v0, [Lorg/joda/time/format/f;
    ...
    invoke-static {v4}, Lorg/joda/time/format/c;->d(LAi/b;)Lorg/joda/time/format/f;
    ...
    invoke-direct {p2, v3}, Lorg/joda/time/format/DateTimeFormatterBuilder$e;-><init>([Lorg/joda/time/format/f;)V
...
.method public b0()Lorg/joda/time/format/a;
    .locals 4

    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->Y()Ljava/lang/Object;

    move-result-object v0

    invoke-direct {p0, v0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->a0(Ljava/lang/Object;)Z
    ...
    check-cast v1, Lorg/joda/time/format/h;
    ...
    :goto_0
    invoke-direct {p0, v0}, Lorg/joda/time/format/DateTimeFormatterBuilder;->Z(Ljava/lang/Object;)Z
    ...
    check-cast v2, Lorg/joda/time/format/f;
    ...
    invoke-direct {v0, v1, v2}, Lorg/joda/time/format/a;-><init>(Lorg/joda/time/format/h;Lorg/joda/time/format/f;)V

    return-object v0
.end method

.method public c(Lorg/joda/time/format/a;)Lorg/joda/time/format/DateTimeFormatterBuilder;
    .locals 1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lorg/joda/time/format/a;->d()Lorg/joda/time/format/h;

    move-result-object v0

    invoke-virtual {p1}, Lorg/joda/time/format/a;->c()Lorg/joda/time/format/f;
...
.method public c0()LAi/b;
    ...
    check-cast v0, Lorg/joda/time/format/f;
