...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1}, LHh/c;->e(Ljava/lang/String;)Ljava/io/InputStream;

    move-result-object p1

    invoke-static {p1}, LHh/c;->d(Ljava/io/InputStream;)Ljava/util/Map;

    move-result-object p1

    iput-object p1, p0, LHh/c;->b:Ljava/util/Map;
...
.method private c(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    iget-object v3, p0, LHh/c;->b:Ljava/util/Map;
    ...
    :goto_0
    :try_start_3
    invoke-virtual {p0, v2}, LHh/c;->g(Ljava/lang/Exception;)V

    iget-object v2, p0, LHh/c;->b:Ljava/util/Map;
...
.method private static d(Ljava/io/InputStream;)Ljava/util/Map;
    ...
    :try_start_0
    invoke-static {v1, v0}, LHh/c;->f(Ljava/io/DataInputStream;Ljava/util/Map;)V
    :try_end_0
...
.method private e(Ljava/lang/String;)Ljava/io/InputStream;
    ...
    iget-object v0, p0, LHh/c;->a:Landroid/content/Context;

    if-eqz v0, :cond_1

    invoke-static {p1}, LHh/b;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    const-class v1, Lnet/danlew/android/joda/R$raw;

    invoke-static {v1, v0}, LHh/b;->b(Ljava/lang/Class;Ljava/lang/String;)I

    move-result v1

    if-eqz v1, :cond_0

    iget-object p1, p0, LHh/c;->a:Landroid/content/Context;
...
.method public a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    :cond_0
    iget-object v1, p0, LHh/c;->b:Ljava/util/Map;
    ...
    invoke-direct {p0, p1}, LHh/c;->c(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    invoke-virtual {p0, v1}, LHh/c;->a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
