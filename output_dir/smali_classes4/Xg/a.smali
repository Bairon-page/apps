...
# direct methods
.method public constructor <init>(Lpg/v;Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses;)V
    .locals 1
    ...
    iput-object p1, p0, LXg/a;->a:Lpg/v;

    iput-object p2, p0, LXg/a;->b:Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses;

    return-void
.end method

.method private final b(LQg/g;Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;)Z
    .locals 6
    ...
    iget-object p3, p0, LXg/a;->a:Lpg/v;

    invoke-virtual {p1, p3}, LQg/g;->a(Lpg/v;)Lbh/v;
    ...
    invoke-direct {p0}, LXg/a;->c()Lkotlin/reflect/jvm/internal/impl/builtins/d;

    move-result-object v0

    invoke-virtual {v0, p2}, Lkotlin/reflect/jvm/internal/impl/builtins/d;->k(Lbh/v;)Lbh/v;
    ...
    invoke-direct {p0, v4, p2, v1}, LXg/a;->b(LQg/g;Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;)Z
    ...
    invoke-static {p1}, Lkotlin/reflect/jvm/internal/impl/builtins/d;->l0(Lpg/a;)Z
...
.method private final c()Lkotlin/reflect/jvm/internal/impl/builtins/d;
    .locals 1

    iget-object v0, p0, LXg/a;->a:Lpg/v;
...
.method private final d(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument;Ljava/util/Map;LJg/c;)Lkotlin/Pair;
    .locals 3
    ...
    invoke-static {p3, v0}, LXg/o;->b(LJg/c;I)LLg/e;
    ...
    invoke-static {p3, v1}, LXg/o;->b(LJg/c;I)LLg/e;
    ...
    invoke-direct {p0, p2, p1, p3}, LXg/a;->g(Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;LJg/c;)LQg/g;
...
.method private final e(LLg/b;)Lpg/a;
    .locals 2

    iget-object v0, p0, LXg/a;->a:Lpg/v;

    iget-object v1, p0, LXg/a;->b:Lkotlin/reflect/jvm/internal/impl/descriptors/NotFoundClasses;
...
.method private final g(Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;LJg/c;)LQg/g;
    .locals 2

    invoke-virtual {p0, p1, p2, p3}, LXg/a;->f(Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;LJg/c;)LQg/g;

    move-result-object p3

    invoke-direct {p0, p3, p1, p2}, LXg/a;->b(LQg/g;Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;)Z
    ...
    sget-object p3, LQg/j;->b:LQg/j$a;
    ...
    invoke-virtual {p3, p1}, LQg/j$a;->a(Ljava/lang/String;)LQg/j;
...
# virtual methods
.method public final a(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;LJg/c;)Lqg/c;
    .locals 5
    ...
    invoke-static {p2, v0}, LXg/o;->a(LJg/c;I)LLg/b;

    move-result-object v0

    invoke-direct {p0, v0}, LXg/a;->e(LLg/b;)Lpg/a;
    ...
    invoke-static {v0}, Ldh/h;->m(Lpg/g;)Z
    ...
    invoke-static {v2}, Lkotlin/collections/k;->S0(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v2, v3, p2}, LXg/a;->d(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument;Ljava/util/Map;LJg/c;)Lkotlin/Pair;
    ...
    :cond_2
    invoke-static {v1}, Lkotlin/collections/y;->t(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-direct {p1, p2, v1, v0}, Lqg/d;-><init>(Lbh/v;Ljava/util/Map;Lpg/J;)V

    return-object p1
.end method

.method public final f(Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;LJg/c;)LQg/g;
    .locals 5
    ...
    sget-object v0, LJg/b;->O:LJg/b$b;
    ...
    invoke-virtual {v3}, Lkotlin/reflect/jvm/internal/impl/builtins/d;->i()Lbh/z;
    ...
    invoke-virtual {p0, v3, v2, p3}, LXg/a;->f(Lbh/v;Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation$Argument$Value;LJg/c;)LQg/g;
    ...
    :cond_1
    invoke-virtual {v0, v1, p1}, Lkotlin/reflect/jvm/internal/impl/resolve/constants/ConstantValueFactory;->a(Ljava/util/List;Lbh/v;)LQg/b;
    ...
    invoke-virtual {p0, p2, p3}, LXg/a;->a(Lkotlin/reflect/jvm/internal/impl/metadata/ProtoBuf$Annotation;LJg/c;)Lqg/c;

    move-result-object p2

    invoke-direct {p1, p2}, LQg/a;-><init>(Lqg/c;)V
    ...
    invoke-static {p3, p2}, LXg/o;->b(LJg/c;I)LLg/e;

    move-result-object p2

    invoke-direct {p1, v0, p2}, LQg/i;-><init>(LLg/b;LLg/e;)V
    ...
    invoke-direct {p1, p3, p2}, LQg/n;-><init>(LLg/b;I)V
    ...
    invoke-interface {p3, p2}, LJg/c;->getString(I)Ljava/lang/String;

    move-result-object p2

    invoke-direct {p1, p2}, LQg/s;-><init>(Ljava/lang/String;)V
    ...
    new-instance p3, LQg/v;

    invoke-direct {p3, p1, p2}, LQg/v;-><init>(J)V
    ...
    invoke-direct {p3, p1, p2}, LQg/o;-><init>(J)V
    ...
    new-instance p2, LQg/u;

    invoke-direct {p2, p1}, LQg/u;-><init>(I)V
    ...
    invoke-direct {p2, p1}, LQg/w;-><init>(S)V
    ...
    invoke-direct {p1, p2}, LQg/e;-><init>(C)V
    ...
    invoke-direct {p2, p1}, LQg/t;-><init>(B)V
