...
.method constructor <init>(Lcom/google/firebase/perf/v1/NetworkRequestMetric;Landroid/content/Context;)V
    ...
    iput-object p2, p0, Lic/c;->b:Landroid/content/Context;

    iput-object p1, p0, Lic/c;->a:Lcom/google/firebase/perf/v1/NetworkRequestMetric;
...
.method private g(Ljava/lang/String;)Ljava/net/URI;
    ...
    invoke-virtual {v1, v2, p1}, Lgc/a;->k(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private h(Ljava/net/URI;Landroid/content/Context;)Z
    ...
    :cond_0
    invoke-static {p1, p2}, Lmc/i;->a(Ljava/net/URI;Landroid/content/Context;)Z
...
.method private j(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Lic/c;->i(Ljava/lang/String;)Z
...
.method public c()Z
    ...
    iget-object v0, p0, Lic/c;->a:Lcom/google/firebase/perf/v1/NetworkRequestMetric;

    invoke-virtual {v0}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->B0()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Lic/c;->j(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Lic/c;->a:Lcom/google/firebase/perf/v1/NetworkRequestMetric;

    invoke-virtual {v3}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->B0()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lic/c;->g(Ljava/lang/String;)Ljava/net/URI;
    ...
    :cond_1
    iget-object v2, p0, Lic/c;->b:Landroid/content/Context;

    invoke-direct {p0, v0, v2}, Lic/c;->h(Ljava/net/URI;Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_2

    sget-object v2, Lic/c;->c:Lgc/a;
    ...
    invoke-virtual {v2, v0}, Lgc/a;->j(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lic/c;->k(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, Lic/c;->p(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v2}, Lic/c;->r(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0}, Lic/c;->o(I)Z
    ...
    invoke-virtual {v0}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->s0()Lcom/google/firebase/perf/v1/NetworkRequestMetric$HttpMethod;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lic/c;->l(Lcom/google/firebase/perf/v1/NetworkRequestMetric$HttpMethod;)Z
    ...
    invoke-virtual {v3}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->s0()Lcom/google/firebase/perf/v1/NetworkRequestMetric$HttpMethod;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->t0()I

    move-result v0

    invoke-direct {p0, v0}, Lic/c;->m(I)Z
    ...
    invoke-virtual {v3}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->t0()I
    ...
    invoke-direct {p0, v2, v3}, Lic/c;->n(J)Z
    ...
    invoke-virtual {v0}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->x0()J
    ...
    invoke-virtual {v3}, Lcom/google/firebase/perf/v1/NetworkRequestMetric;->x0()J
    ...
    invoke-direct {p0, v2, v3}, Lic/c;->q(J)Z
