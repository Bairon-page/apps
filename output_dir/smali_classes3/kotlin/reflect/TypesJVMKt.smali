...
# direct methods
.method public static final synthetic a(Lgg/n;Z)Ljava/lang/reflect/Type;
    .locals 0

    invoke-static {p0, p1}, Lkotlin/reflect/TypesJVMKt;->c(Lgg/n;Z)Ljava/lang/reflect/Type;
...
.method private static final c(Lgg/n;Z)Ljava/lang/reflect/Type;
    .locals 3
    ...
    invoke-direct {p0, v0}, Lkotlin/reflect/b;-><init>(Lgg/o;)V
    ...
    invoke-static {v0}, LYf/a;->c(Lgg/c;)Ljava/lang/Class;
    ...
    :goto_0
    invoke-interface {p0}, Lgg/n;->b()Ljava/util/List;
    ...
    :cond_3
    invoke-static {v0}, Lkotlin/collections/k;->T0(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lgg/p;->a()Lkotlin/reflect/KVariance;

    move-result-object p0

    invoke-virtual {v0}, Lgg/p;->b()Lgg/n;
    ...
    invoke-static {v0, p0, v1, v2}, Lkotlin/reflect/TypesJVMKt;->d(Lgg/n;ZILjava/lang/Object;)Ljava/lang/reflect/Type;
...
.method static synthetic d(Lgg/n;ZILjava/lang/Object;)Ljava/lang/reflect/Type;
    .locals 0
...
.method private static final e(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/reflect/Type;
    ...
    invoke-static {v1}, Lkotlin/reflect/TypesJVMKt;->g(Lgg/p;)Ljava/lang/reflect/Type;
...
.method public static final f(Lgg/n;)Ljava/lang/reflect/Type;
    ...
    invoke-interface {v0}, Lkotlin/jvm/internal/p;->f()Ljava/lang/reflect/Type;
    ...
    invoke-static {p0, v2, v0, v1}, Lkotlin/reflect/TypesJVMKt;->d(Lgg/n;ZILjava/lang/Object;)Ljava/lang/reflect/Type;
...
.method private static final g(Lgg/p;)Ljava/lang/reflect/Type;
    .locals 4

    invoke-virtual {p0}, Lgg/p;->d()Lkotlin/reflect/KVariance;
    ...
    :cond_0
    invoke-virtual {p0}, Lgg/p;->c()Lgg/n;
    ...
    invoke-static {p0, v2}, Lkotlin/reflect/TypesJVMKt;->c(Lgg/n;Z)Ljava/lang/reflect/Type;
...
.method private static final h(Ljava/lang/reflect/Type;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lkotlin/sequences/d;->H(Llh/f;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lkotlin/sequences/d;->v(Llh/f;)I

    move-result p0

    invoke-static {v1, p0}, Lkotlin/text/g;->F(Ljava/lang/CharSequence;I)Ljava/lang/String;
