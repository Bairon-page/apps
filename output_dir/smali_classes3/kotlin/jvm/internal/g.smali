...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lkotlin/jvm/internal/g$a;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lkotlin/jvm/internal/g;->b:Lkotlin/jvm/internal/g$a;

    const-class v23, LZf/n;

    const-class v24, LZf/o;

    const-class v2, LZf/a;

    const-class v3, LZf/l;

    const-class v4, LZf/p;

    const-class v5, LZf/q;

    const-class v6, LZf/r;

    const-class v7, LZf/s;

    const-class v8, LZf/t;

    const-class v9, LZf/u;

    const-class v10, LZf/v;

    const-class v11, LZf/w;

    const-class v12, LZf/b;

    const-class v13, LZf/c;

    const-class v14, LZf/d;

    const-class v15, LZf/e;

    const-class v16, LZf/f;

    const-class v17, LZf/g;

    const-class v18, LZf/h;

    const-class v19, LZf/i;

    const-class v20, LZf/j;

    const-class v21, LZf/k;

    const-class v22, LZf/m;
    ...
    sput-object v0, Lkotlin/jvm/internal/g;->d:Ljava/util/HashMap;
    ...
    sput-object v2, Lkotlin/jvm/internal/g;->e:Ljava/util/HashMap;
    ...
    invoke-static {v2, v5, v1, v4, v1}, Lkotlin/text/g;->a1(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    sput-object v3, Lkotlin/jvm/internal/g;->f:Ljava/util/HashMap;
    ...
    invoke-static {v3, v5, v1, v4, v1}, Lkotlin/text/g;->a1(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_4
    sput-object v0, Lkotlin/jvm/internal/g;->v:Ljava/util/Map;
...
.method public static final synthetic l()Ljava/util/HashMap;
    ...
    sget-object v0, Lkotlin/jvm/internal/g;->f:Ljava/util/HashMap;
...
.method public static final synthetic q()Ljava/util/Map;
    ...
    sget-object v0, Lkotlin/jvm/internal/g;->v:Ljava/util/Map;
...
.method public i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/g;->k()Ljava/lang/Class;
...
.method public j()Ljava/util/Collection;
    ...
    invoke-direct {p0}, Lkotlin/jvm/internal/g;->r()Ljava/lang/Void;
