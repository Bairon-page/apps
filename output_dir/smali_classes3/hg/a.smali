...
# direct methods
.method private static final a(Lkotlin/reflect/jvm/internal/impl/types/n;Lbh/I;Ljava/util/List;Z)Lbh/z;
    .locals 8
    ...
    invoke-virtual {v2}, Lgg/p;->c()Lgg/n;
    ...
    invoke-virtual {v5}, Lkotlin/reflect/jvm/internal/KTypeImpl;->m()Lbh/v;
    ...
    :goto_1
    invoke-virtual {v2}, Lgg/p;->d()Lkotlin/reflect/KVariance;
    ...
    invoke-direct {v1, v2, v5}, Lbh/M;-><init>(Lkotlin/reflect/jvm/internal/impl/types/Variance;Lbh/v;)V
    ...
    invoke-direct {v2, v1}, Lkotlin/reflect/jvm/internal/impl/types/StarProjectionImpl;-><init>(Lpg/O;)V
...
.method public static final b(Lgg/d;Ljava/util/List;ZLjava/util/List;)Lgg/n;
    .locals 4
    ...
    invoke-interface {v0}, Ljg/e;->getDescriptor()Lpg/c;
    ...
    sget-object p3, Lkotlin/reflect/jvm/internal/impl/types/n;->b:Lkotlin/reflect/jvm/internal/impl/types/n$a;

    invoke-virtual {p3}, Lkotlin/reflect/jvm/internal/impl/types/n$a;->h()Lkotlin/reflect/jvm/internal/impl/types/n;
    ...
    invoke-static {p3, p0, p1, p2}, Lhg/a;->a(Lkotlin/reflect/jvm/internal/impl/types/n;Lbh/I;Ljava/util/List;Z)Lbh/z;

    move-result-object p0

    const/4 p1, 0x2

    invoke-direct {v0, p0, v1, p1, v1}, Lkotlin/reflect/jvm/internal/KTypeImpl;-><init>(Lbh/v;LZf/a;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
