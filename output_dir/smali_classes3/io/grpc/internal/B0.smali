...
.method public static A(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Lio/grpc/internal/B0;->z(Ljava/util/Map;)Lio/grpc/internal/B0$a;
...
.method public static b(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
...
.method static c(Ljava/util/Map;)Ljava/lang/Long;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->l(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Long;
...
.method private static f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p0, p1}, Lio/grpc/internal/W;->e(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {p0}, Lio/grpc/internal/B0;->u(Ljava/util/List;)Ljava/util/Set;
...
.method public static g(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lio/grpc/internal/W;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, v1}, Lio/grpc/internal/W;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method static h(Ljava/util/Map;)Ljava/lang/Integer;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->i(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Integer;
...
.method static m(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
...
.method static n(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method static p(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/B0;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {v1, v2, v0}, Lbb/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method static s(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {v2, v3, v0}, Lbb/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method private static u(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {v4, v7, v1}, Lbb/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lio/grpc/Status$Code;->d()I
    ...
    invoke-static {v5, v2, v1}, Lbb/q;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method static v(Ljava/util/Map;)Lio/grpc/internal/t0$D;
    .locals 6
    ...
    invoke-static {p0, v1}, Lio/grpc/internal/W;->j(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lio/grpc/internal/W;->h(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Double;
    ...
    invoke-direct {v1, v0, p0}, Lio/grpc/internal/t0$D;-><init>(FF)V
...
.method static x(Ljava/util/Map;)Ljava/lang/Boolean;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/W;->d(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/Boolean;
...
.method public static y(Ljava/util/List;Lio/grpc/s;)Lio/grpc/w$b;
    .locals 4
    ...
    invoke-virtual {v1}, Lio/grpc/internal/B0$a;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p1, v2}, Lio/grpc/s;->d(Ljava/lang/String;)Lio/grpc/r;
    ...
    const-class p0, Lio/grpc/internal/B0;
    ...
    :cond_1
    invoke-virtual {v1}, Lio/grpc/internal/B0$a;->b()Ljava/util/Map;

    move-result-object p0

    invoke-virtual {v3, p0}, Lio/grpc/r;->e(Ljava/util/Map;)Lio/grpc/w$b;

    move-result-object p0

    invoke-virtual {p0}, Lio/grpc/w$b;->d()Lio/grpc/Status;
    ...
    :cond_2
    new-instance p1, Lio/grpc/internal/B0$b;

    invoke-virtual {p0}, Lio/grpc/w$b;->c()Ljava/lang/Object;

    move-result-object p0

    invoke-direct {p1, v3, p0}, Lio/grpc/internal/B0$b;-><init>(Lio/grpc/r;Ljava/lang/Object;)V
...
.method public static z(Ljava/util/Map;)Lio/grpc/internal/B0$a;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lio/grpc/internal/B0$a;-><init>(Ljava/lang/String;Ljava/util/Map;)V
