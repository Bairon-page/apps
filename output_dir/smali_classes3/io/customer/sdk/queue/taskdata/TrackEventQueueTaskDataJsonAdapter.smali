.class public final Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;",
        "Lcom/squareup/moshi/f;",
        "Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;",
        ...
        "reader",
        "k",
        "(Lcom/squareup/moshi/JsonReader;)Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;",
        "Lcom/squareup/moshi/j;",
        "writer",
        "value_",
        "LNf/u;",
        "l",
        "(Lcom/squareup/moshi/j;Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;)V",
...
.method public constructor <init>(Lcom/squareup/moshi/l;)V
    ...
    const-string v3, "of(\"identifier\", \"event\")"

    invoke-static {v2, v3}, Lkotlin/jvm/internal/o;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v2, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->a:Lcom/squareup/moshi/JsonReader$a;
    ...
    iput-object v0, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->b:Lcom/squareup/moshi/f;

    const-class v0, Lio/customer/sdk/data/request/Event;
    ...
    const-string v0, "moshi.adapter(Event::cla\u2026mptySet(),\n      \"event\")"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/o;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p1, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->c:Lcom/squareup/moshi/f;
...
.method public bridge synthetic b(Lcom/squareup/moshi/JsonReader;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->k(Lcom/squareup/moshi/JsonReader;)Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;
...
.method public bridge synthetic j(Lcom/squareup/moshi/j;Ljava/lang/Object;)V
    ...
    check-cast p2, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;

    invoke-virtual {p0, p1, p2}, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->l(Lcom/squareup/moshi/j;Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;)V

    return-void
.end method

.method public k(Lcom/squareup/moshi/JsonReader;)Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;
    .locals 6
    ...
    iget-object v2, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->a:Lcom/squareup/moshi/JsonReader$a;
    ...
    :cond_0
    iget-object v1, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->c:Lcom/squareup/moshi/f;
    ...
    const-string v0, "unexpectedNull(\"event\", \u2026ent\",\n            reader)"
    ...
    :cond_2
    iget-object v0, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->b:Lcom/squareup/moshi/f;
    ...
    new-instance v2, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;

    if-eqz v0, :cond_7

    if-eqz v1, :cond_6

    invoke-direct {v2, v0, v1}, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;-><init>(Ljava/lang/String;Lio/customer/sdk/data/request/Event;)V
...
.method public l(Lcom/squareup/moshi/j;Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;)V
    .locals 2
    ...
    invoke-virtual {p2}, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;->b()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskDataJsonAdapter;->c:Lcom/squareup/moshi/f;

    invoke-virtual {p2}, Lio/customer/sdk/queue/taskdata/TrackEventQueueTaskData;->a()Lio/customer/sdk/data/request/Event;
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "TrackEventQueueTaskData"
