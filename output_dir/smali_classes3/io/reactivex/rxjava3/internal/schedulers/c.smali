...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/rxjava3/internal/schedulers/c;->f:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/rxjava3/internal/schedulers/c;->e:Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/rxjava3/internal/schedulers/c;->e:Lio/reactivex/rxjava3/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/rxjava3/internal/schedulers/c;->d:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    iput-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/c;->c:Ljava/util/concurrent/ThreadFactory;

    .line 5
    invoke-static {p1}, Lio/reactivex/rxjava3/internal/schedulers/c;->g(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method static g(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {p0}, LAf/e;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public c()Lnf/r$c;
    ...
    iget-object v1, p0, Lio/reactivex/rxjava3/internal/schedulers/c;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lio/reactivex/rxjava3/internal/schedulers/c$a;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/a;
    ...
    :try_start_0
    iget-object p1, p0, Lio/reactivex/rxjava3/internal/schedulers/c;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public f(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lio/reactivex/rxjava3/disposables/a;
    ...
    iget-object p4, p0, Lio/reactivex/rxjava3/internal/schedulers/c;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance p5, Lio/reactivex/rxjava3/internal/schedulers/a;

    invoke-direct {p5, p1, p4}, Lio/reactivex/rxjava3/internal/schedulers/a;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p5, p1}, Lio/reactivex/rxjava3/internal/schedulers/a;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
