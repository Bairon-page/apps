...
.field private static final synthetic b:[Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;
...
.method public static a(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    invoke-interface {p0}, LIi/c;->cancel()V
...
.method public static c(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, LIi/c;->o(J)V

    goto :goto_0

    :cond_0
    invoke-static {p2, p3}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->l(J)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p1, p2, p3}, LBf/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {p0, v0, v1}, LIi/c;->o(J)V
...
.method public static d(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;LIi/c;)Z
    .locals 2

    invoke-static {p0, p2}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->j(Ljava/util/concurrent/atomic/AtomicReference;LIi/c;)Z
    ...
    invoke-interface {p2, p0, p1}, LIi/c;->o(J)V
...
.method public static j(Ljava/util/concurrent/atomic/AtomicReference;LIi/c;)Z
    .locals 1
    ...
    invoke-static {p0, v0, p1}, Lu/Q;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {}, Lio/reactivex/rxjava3/internal/subscriptions/SubscriptionHelper;->f()V
...
.method public static m(LIi/c;LIi/c;)Z
    .locals 1
