...
.method constructor <init>(LIi/b;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->v:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->a:LIi/b;
...
.method public b(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->v:Ljava/util/concurrent/atomic/AtomicReference;
...
.method c(ZZLIi/b;Ljava/util/concurrent/atomic/AtomicReference;)Z
    .locals 3
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->b:LIi/c;
...
.method d()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->a:LIi/b;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->v:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_1
    invoke-virtual {p0, v9, v12, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->c(ZZLIi/b;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    :cond_4
    invoke-interface {v0, v11}, LIi/b;->b(Ljava/lang/Object;)V
    ...
    :cond_6
    invoke-virtual {p0, v9, v10, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->c(ZZLIi/b;Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    invoke-static {v1, v7, v8}, Lif/b;->d(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public e(LIi/c;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureLatest$BackpressureLatestSubscriber;->b:LIi/c;
