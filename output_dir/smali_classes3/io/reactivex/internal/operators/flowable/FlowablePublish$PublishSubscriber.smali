...
# static fields
.field static final x:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;

.field static final y:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
.method public a()V
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->h()V
...
.method public b(Ljava/lang/Object;)V
    ...
    iget v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->v:I

    if-nez v0, :cond_0

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->w:LYe/j;
...
.method public c()Z
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->y:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
...
.method d(Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;)Z
    .locals 4
...
.method public dispose()V
    ...
    invoke-static {v0, p0, v1}, Lu/Q;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public e(LIi/c;)V
    ...
    invoke-static {v0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->j(Ljava/util/concurrent/atomic/AtomicReference;LIi/c;)Z
    ...
    iput v1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->v:I

    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->w:LYe/j;
...
.method f(Ljava/lang/Object;Z)Z
    ...
    invoke-static {p1, p0, v2}, Lu/Q;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    sget-object p2, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->y:[Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;
    ...
    iget-object v1, v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->a:LIi/b;
    ...
    invoke-static {p2, p0, v2}, Lu/Q;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v2, v2, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->a:LIi/b;

    invoke-interface {v2, p1}, LIi/b;->onError(Ljava/lang/Throwable;)V
...
.method h()V
    ...
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->w:LYe/j;

    if-eqz v6, :cond_3

    invoke-interface {v6}, LYe/j;->isEmpty()Z
    ...
    :goto_2
    invoke-virtual {v1, v0, v8}, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->f(Ljava/lang/Object;Z)Z
    ...
    :try_start_0
    invoke-interface {v6}, LYe/j;->poll()Ljava/lang/Object;
    ...
    invoke-static {v6}, LTe/a;->b(Ljava/lang/Throwable;)V
    ...
    invoke-static {v6}, Lio/reactivex/internal/util/NotificationLite;->d(Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    :goto_6
    invoke-virtual {v1, v0, v7}, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->f(Ljava/lang/Object;Z)Z
    ...
    :cond_8
    iget v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublish$PublishSubscriber;->v:I
    ...
    invoke-interface {v0, v9, v10}, LIi/c;->o(J)V
    ...
    invoke-static {v8}, LTe/a;->b(Ljava/lang/Throwable;)V
    ...
    invoke-static {v8}, Lio/reactivex/internal/util/NotificationLite;->d(Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    :goto_b
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;->a:LIi/b;

    invoke-interface {v3, v0}, LIi/b;->b(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, v12, v13}, LIi/c;->o(J)V
...
.method i(Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;)V
    .locals 6
