...
.method constructor <init>(Lcom/google/firebase/f;LUb/b;Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/Executor;)V
    .locals 9
    ...
    invoke-direct {v4, v0, p2}, Lcom/google/firebase/installations/remote/c;-><init>(Landroid/content/Context;LUb/b;)V
    ...
    invoke-direct {p2, p1}, LVb/a;-><init>(Lcom/google/firebase/f;)V

    invoke-direct {v7, p2}, Lnb/t;-><init>(LUb/b;)V

    new-instance v8, LVb/g;

    invoke-direct {v8}, LVb/g;-><init>()V
    ...
    .line 4
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/installations/c;-><init>(Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/Executor;Lcom/google/firebase/f;Lcom/google/firebase/installations/remote/c;Lcom/google/firebase/installations/local/PersistedInstallation;Lcom/google/firebase/installations/h;Lnb/t;LVb/g;)V

    return-void
.end method

.method constructor <init>(Ljava/util/concurrent/ExecutorService;Ljava/util/concurrent/Executor;Lcom/google/firebase/f;Lcom/google/firebase/installations/remote/c;Lcom/google/firebase/installations/local/PersistedInstallation;Lcom/google/firebase/installations/h;Lnb/t;LVb/g;)V
    .locals 1
    ...
    .line 13
    iput-object p7, p0, Lcom/google/firebase/installations/c;->e:Lnb/t;

    .line 14
    iput-object p8, p0, Lcom/google/firebase/installations/c;->f:LVb/g;
...
.method private B(Lcom/google/firebase/installations/local/b;)Ljava/lang/String;
    .locals 2
    ...
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/installations/c;->f:LVb/g;

    invoke-virtual {p1}, LVb/g;->a()Ljava/lang/String;
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/firebase/installations/c;->p()LWb/a;

    move-result-object p1

    invoke-virtual {p1}, LWb/a;->f()Ljava/lang/String;
...
.method private C(Lcom/google/firebase/installations/local/b;)Lcom/google/firebase/installations/local/b;
    .locals 10
    ...
    invoke-virtual {v0}, LWb/a;->i()Ljava/lang/String;
...
.method private E(Lcom/google/firebase/installations/local/b;)V
    .locals 3
...
.method private declared-synchronized G(Lcom/google/firebase/installations/local/b;Lcom/google/firebase/installations/local/b;)V
    .locals 1
...
.method public static synthetic f(Lcom/google/firebase/f;)LWb/a;
    .locals 0

    invoke-static {p0}, Lcom/google/firebase/installations/c;->z(Lcom/google/firebase/f;)LWb/a;
...
.method private j(Z)V
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, v0}, Lcom/google/firebase/installations/c;->l(Lcom/google/firebase/installations/local/b;)Lcom/google/firebase/installations/local/b;
    ...
    :cond_3
    :goto_1
    invoke-direct {p0, v0}, Lcom/google/firebase/installations/c;->C(Lcom/google/firebase/installations/local/b;)Lcom/google/firebase/installations/local/b;
    ...
    :goto_2
    invoke-direct {p0, p1}, Lcom/google/firebase/installations/c;->v(Lcom/google/firebase/installations/local/b;)V

    invoke-direct {p0, v0, p1}, Lcom/google/firebase/installations/c;->G(Lcom/google/firebase/installations/local/b;Lcom/google/firebase/installations/local/b;)V
    ...
    :cond_6
    invoke-direct {p0, p1}, Lcom/google/firebase/installations/c;->E(Lcom/google/firebase/installations/local/b;)V
...
.method private final k(Z)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/installations/c;->t()Lcom/google/firebase/installations/local/b;
    ...
    :cond_0
    invoke-direct {p0, v0}, Lcom/google/firebase/installations/c;->E(Lcom/google/firebase/installations/local/b;)V

    iget-object v0, p0, Lcom/google/firebase/installations/c;->i:Ljava/util/concurrent/Executor;

    new-instance v1, LVb/d;

    invoke-direct {v1, p0, p1}, LVb/d;-><init>(Lcom/google/firebase/installations/c;Z)V
...
.method private l(Lcom/google/firebase/installations/local/b;)Lcom/google/firebase/installations/local/b;
    .locals 6
...
.method private p()LWb/a;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/installations/c;->e:Lnb/t;
...
.method private t()Lcom/google/firebase/installations/local/b;
    .locals 5
    ...
    invoke-direct {p0, v2}, Lcom/google/firebase/installations/c;->B(Lcom/google/firebase/installations/local/b;)Ljava/lang/String;
...
.method private v(Lcom/google/firebase/installations/local/b;)V
    .locals 3
...
.method private static synthetic z(Lcom/google/firebase/f;)LWb/a;
    .locals 1

    new-instance v0, LWb/a;

    invoke-direct {v0, p0}, LWb/a;-><init>(Lcom/google/firebase/f;)V
...
.method public a()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0}, LVb/b;-><init>(Lcom/google/firebase/installations/c;)V
...
.method public b(Z)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v2, p0, p1}, LVb/c;-><init>(Lcom/google/firebase/installations/c;Z)V
