...
.field private firebaseRemoteConfigProvider:LUb/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LUb/b;"
        }
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lgc/a;
...
.method constructor <init>(Lcom/google/firebase/perf/config/w;Ljava/util/concurrent/Executor;Lcom/google/firebase/remoteconfig/a;JJ)V
    ...
    invoke-virtual {p3}, Lcom/google/firebase/remoteconfig/a;->k()Ljava/util/Map;
...
.method static getInitialStartupMillis()J
    ...
    :catch_0
    sget-object v0, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lgc/a;
...
.method private getRemoteConfigValue(Ljava/lang/String;)Lpc/l;
    .locals 3
    ...
    sget-object v1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lgc/a;

    invoke-interface {v0}, Lpc/l;->a()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lgc/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private synthetic lambda$triggerFirebaseRemoteConfigFetchAndActivateOnSuccessfulFetch$0(Ljava/lang/Boolean;)V
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/a;->k()Ljava/util/Map;
...
.method private triggerRemoteConfigFetchIfNecessary()V
    ...
    invoke-virtual {v1}, Lcom/google/firebase/remoteconfig/a;->k()Ljava/util/Map;
...
# virtual methods
.method public getBoolean(Ljava/lang/String;)Lmc/e;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p1, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lgc/a;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/config/RemoteConfigManager;->getRemoteConfigValue(Ljava/lang/String;)Lpc/l;
    ...
    invoke-static {v1}, Lmc/e;->e(Ljava/lang/Object;)Lmc/e;
...
.method public getDouble(Ljava/lang/String;)Lmc/e;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getLong(Ljava/lang/String;)Lmc/e;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getRemoteConfigValueOrDefault(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_1
    sget-object v2, Lcom/google/firebase/perf/config/RemoteConfigManager;->logger:Lgc/a;
    ...
    invoke-virtual {v2, v3, p2}, Lgc/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
...
.method public getString(Ljava/lang/String;)Lmc/e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1}, Lpc/l;->a()Ljava/lang/String;
...
.method public isFirebaseRemoteConfigAvailable()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:LUb/b;
    ...
    check-cast v0, Lcom/google/firebase/remoteconfig/d;

    if-eqz v0, :cond_0

    const-string v1, "fireperf"

    invoke-virtual {v0, v1}, Lcom/google/firebase/remoteconfig/d;->e(Ljava/lang/String;)Lcom/google/firebase/remoteconfig/a;
...
.method public isLastFetchFailed()Z
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/a;->m()Lpc/k;

    move-result-object v0

    invoke-interface {v0}, Lpc/k;->a()I
...
.method public setFirebaseRemoteConfigProvider(LUb/b;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/perf/config/RemoteConfigManager;->firebaseRemoteConfigProvider:LUb/b;
