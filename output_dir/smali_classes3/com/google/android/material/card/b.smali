...
.field private q:LOa/g;

.field private r:LOa/g;
...
.method public constructor <init>(Lcom/google/android/material/card/MaterialCardView;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v1, v2, p2, p3, p4}, LOa/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v1, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {p1}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p4

    invoke-virtual {v1, p4}, LOa/g;->M(Landroid/content/Context;)V

    const p4, -0xbbbbbc

    invoke-virtual {v1, p4}, LOa/g;->c0(I)V

    invoke-virtual {v1}, LOa/g;->D()LOa/k;

    move-result-object p4

    invoke-virtual {p4}, LOa/k;->v()LOa/k$b;
    ...
    invoke-virtual {p4, p3}, LOa/k$b;->o(F)LOa/k$b;

    :cond_0
    new-instance p3, LOa/g;

    invoke-direct {p3}, LOa/g;-><init>()V

    iput-object p3, p0, Lcom/google/android/material/card/b;->d:LOa/g;

    invoke-virtual {p4}, LOa/k$b;->m()LOa/k;

    move-result-object p3

    invoke-virtual {p0, p3}, Lcom/google/android/material/card/b;->Z(LOa/k;)V
    ...
    invoke-static {p3, p4, v0}, LJa/h;->g(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, v0}, LJa/h;->f(Landroid/content/Context;II)I
    ...
    invoke-static {p1, p3, v0}, LJa/h;->f(Landroid/content/Context;II)I
...
.method private c()F
    ...
    iget-object v0, p0, Lcom/google/android/material/card/b;->m:LOa/k;

    invoke-virtual {v0}, LOa/k;->q()LOa/d;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {v1}, LOa/g;->F()F

    move-result v1

    invoke-direct {p0, v0, v1}, Lcom/google/android/material/card/b;->d(LOa/d;F)F

    move-result v0

    iget-object v1, p0, Lcom/google/android/material/card/b;->m:LOa/k;

    invoke-virtual {v1}, LOa/k;->s()LOa/d;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {v2}, LOa/g;->G()F

    move-result v2

    invoke-direct {p0, v1, v2}, Lcom/google/android/material/card/b;->d(LOa/d;F)F
    ...
    invoke-virtual {v1}, LOa/k;->k()LOa/d;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {v2}, LOa/g;->t()F
    ...
    iget-object v2, p0, Lcom/google/android/material/card/b;->m:LOa/k;

    invoke-virtual {v2}, LOa/k;->i()LOa/d;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {v3}, LOa/g;->s()F

    move-result v3

    invoke-direct {p0, v2, v3}, Lcom/google/android/material/card/b;->d(LOa/d;F)F
...
.method private g()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/card/b;->c:LOa/g;

    invoke-virtual {v0}, LOa/g;->P()Z
...
.method private h()Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0}, Lcom/google/android/material/card/b;->j()LOa/g;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/material/card/b;->q:LOa/g;

    iget-object v2, p0, Lcom/google/android/material/card/b;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v1, v2}, LOa/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/card/b;->q:LOa/g;
...
.method private i()Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lcom/google/android/material/card/b;->r:LOa/g;
    ...
    iget-object v3, p0, Lcom/google/android/material/card/b;->r:LOa/g;
...
.method private l0()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/card/b;->q:LOa/g;
...
.method private t()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Lcom/google/android/material/card/b;->d:LOa/g;
...
.method J(Landroid/content/res/TypedArray;)V
    ...
    invoke-static {v0, p1, v1}, LLa/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, v2}, LLa/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, v2}, LLa/c;->e(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    iget-object p1, p0, Lcom/google/android/material/card/b;->d:LOa/g;
...
.method M(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p1}, LOa/g;->X(Landroid/content/res/ColorStateList;)V
...
.method N(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/card/b;->d:LOa/g;
...
.method W(F)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/material/card/b;->Z(LOa/k;)V
...
.method X(F)V
    ...
    invoke-virtual {v0, p1}, LOa/g;->Y(F)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/card/b;->r:LOa/g;
...
.method Z(LOa/k;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/card/b;->m:LOa/k;
    ...
    invoke-virtual {v0, v1}, LOa/g;->b0(Z)V
...
.method g0()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/material/card/b;->d:LOa/g;
...
.method m()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0}, LOa/g;->x()Landroid/content/res/ColorStateList;
...
.method m0()V
    ...
    invoke-virtual {v0, v1, v2}, LOa/g;->e0(FLandroid/content/res/ColorStateList;)V
