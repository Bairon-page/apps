...
.method constructor <init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;LNa/b;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/material/floatingactionbutton/d;-><init>(Lcom/google/android/material/floatingactionbutton/FloatingActionButton;LNa/b;)V
...
.method private g0(FFF)Landroid/animation/StateListAnimator;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/android/material/floatingactionbutton/e;->h0(FF)Landroid/animation/Animator;
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/material/floatingactionbutton/e;->h0(FF)Landroid/animation/Animator;
    ...
    invoke-direct {p0, v2, v2}, Lcom/google/android/material/floatingactionbutton/e;->h0(FF)Landroid/animation/Animator;
...
.method C(FFF)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/floatingactionbutton/e;->g0(FFF)Landroid/animation/StateListAnimator;
...
.method S(Landroid/content/res/ColorStateList;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/google/android/material/floatingactionbutton/d;->S(Landroid/content/res/ColorStateList;)V
...
.method W()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->x:LNa/b;

    invoke-interface {v0}, LNa/b;->c()Z
...
.method f0(ILandroid/content/res/ColorStateList;)Lcom/google/android/material/floatingactionbutton/c;
    .locals 6
    ...
    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/d;->a:LOa/k;

    invoke-static {v2}, Lq1/i;->g(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, LOa/k;

    invoke-direct {v1, v2}, Lcom/google/android/material/floatingactionbutton/c;-><init>(LOa/k;)V
...
.method i0()LOa/g;
    ...
    invoke-direct {v1, v0}, Lcom/google/android/material/floatingactionbutton/e$a;-><init>(LOa/k;)V
...
.method o(Landroid/graphics/Rect;)V
    ...
    invoke-super {p0, p1}, Lcom/google/android/material/floatingactionbutton/d;->o(Landroid/graphics/Rect;)V
...
.method u(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/floatingactionbutton/e;->i0()LOa/g;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->b:LOa/g;
    ...
    invoke-virtual {v0, p2}, LOa/g;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    iget-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->b:LOa/g;
    ...
    invoke-virtual {p2, v0}, LOa/g;->M(Landroid/content/Context;)V

    const/4 p2, 0x0

    if-lez p4, :cond_1

    invoke-virtual {p0, p4, p1}, Lcom/google/android/material/floatingactionbutton/e;->f0(ILandroid/content/res/ColorStateList;)Lcom/google/android/material/floatingactionbutton/c;
    ...
    invoke-static {p4}, Lq1/i;->g(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->b:LOa/g;

    :goto_0
    new-instance p4, Landroid/graphics/drawable/RippleDrawable;

    invoke-static {p3}, LMa/b;->d(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
