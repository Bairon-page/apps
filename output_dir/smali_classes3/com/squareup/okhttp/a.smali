...
# instance fields
.field final a:Lcom/squareup/okhttp/HttpUrl;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;ILBd/h;Ljavax/net/SocketFactory;Ljavax/net/ssl/SSLSocketFactory;Ljavax/net/ssl/HostnameVerifier;LBd/d;LBd/a;Ljava/net/Proxy;Ljava/util/List;Ljava/util/List;Ljava/net/ProxySelector;)V
    .locals 2
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/HttpUrl$Builder;->v(Ljava/lang/String;)Lcom/squareup/okhttp/HttpUrl$Builder;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/HttpUrl$Builder;->j(Ljava/lang/String;)Lcom/squareup/okhttp/HttpUrl$Builder;

    move-result-object p1

    invoke-virtual {p1, p2}, Lcom/squareup/okhttp/HttpUrl$Builder;->q(I)Lcom/squareup/okhttp/HttpUrl$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lcom/squareup/okhttp/HttpUrl$Builder;->b()Lcom/squareup/okhttp/HttpUrl;

    move-result-object p1

    iput-object p1, p0, Lcom/squareup/okhttp/a;->a:Lcom/squareup/okhttp/HttpUrl;

    if-eqz p3, :cond_6

    iput-object p3, p0, Lcom/squareup/okhttp/a;->b:LBd/h;
    ...
    iput-object p8, p0, Lcom/squareup/okhttp/a;->d:LBd/a;

    if-eqz p10, :cond_3

    invoke-static {p10}, LCd/h;->j(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p11}, LCd/h;->j(Ljava/util/List;)Ljava/util/List;
    ...
    iput-object p7, p0, Lcom/squareup/okhttp/a;->k:LBd/d;
...
.method public a()LBd/a;
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/a;->d:LBd/a;
...
.method public b()LBd/d;
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/a;->k:LBd/d;
...
.method public d()LBd/h;
    .locals 1

    iget-object v0, p0, Lcom/squareup/okhttp/a;->b:LBd/h;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/a;->a:Lcom/squareup/okhttp/HttpUrl;

    iget-object v2, p1, Lcom/squareup/okhttp/a;->a:Lcom/squareup/okhttp/HttpUrl;
    ...
    iget-object v2, p1, Lcom/squareup/okhttp/a;->b:LBd/h;
    ...
    iget-object v2, p1, Lcom/squareup/okhttp/a;->d:LBd/a;
    ...
    invoke-static {v0, v2}, LCd/h;->h(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lcom/squareup/okhttp/a;->k:LBd/d;

    invoke-static {v0, p1}, LCd/h;->h(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public m()Lcom/squareup/okhttp/HttpUrl;
    .locals 1
