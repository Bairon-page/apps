...
.method private static a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
    ...
    invoke-static {p0, p1, v0, v1, v2}, Ltb/F;->b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method private static b(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-direct/range {v2 .. v7}, Ltb/F$b;-><init>(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;JLjava/util/concurrent/TimeUnit;)V
...
.method public static c(Ljava/lang/String;)Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {p0}, Ltb/F;->d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-static {v0, v1}, Ltb/F;->e(Ljava/util/concurrent/ThreadFactory;Ljava/util/concurrent/RejectedExecutionHandler;)Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-static {p0, v0}, Ltb/F;->a(Ljava/lang/String;Ljava/util/concurrent/ExecutorService;)V
...
.method public static d(Ljava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v1, p0, v0}, Ltb/F$a;-><init>(Ljava/lang/String;Ljava/util/concurrent/atomic/AtomicLong;)V
