...
# direct methods
.method constructor <init>(IZLSh/d;)V
    .locals 1
    ...
    .line 9
    iput-object p3, p0, Lxe/d$b;->a:LSh/d;
...
.method constructor <init>(LSh/d;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Lxe/d$b;-><init>(IZLSh/d;)V
...
.method private c(Lxe/c;)V
    ...
    invoke-direct {p0, v2}, Lxe/d$b;->b(I)I
...
.method d(Lokio/ByteString;)V
    ...
    invoke-virtual {p1}, Lokio/ByteString;->c0()[B

    move-result-object v2

    invoke-virtual {v0, v2}, Lxe/f;->e([B)I
    ...
    invoke-virtual {v2, p1, v3}, Lxe/f;->d([BLjava/io/OutputStream;)V
    ...
    invoke-virtual {p0, v0, v1, v2}, Lxe/d$b;->f(III)V

    iget-object v0, p0, Lxe/d$b;->a:LSh/d;
...
.method e(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0, v4, v3}, Lxe/d$b;->f(III)V
    ...
    invoke-virtual {v4}, Lokio/ByteString;->a0()Lokio/ByteString;

    move-result-object v4

    iget-object v5, v3, Lxe/c;->b:Lokio/ByteString;

    invoke-static {}, Lxe/d;->c()Ljava/util/Map;
    ...
    iget-object v9, v9, Lxe/c;->b:Lokio/ByteString;
    ...
    iget-object v10, v10, Lxe/c;->a:Lokio/ByteString;
    ...
    iget-object v10, v10, Lxe/c;->b:Lokio/ByteString;
    ...
    invoke-virtual {p0, v8, v3, v4}, Lxe/d$b;->f(III)V
    ...
    iget-object v6, p0, Lxe/d$b;->a:LSh/d;

    invoke-virtual {v6, v8}, LSh/d;->L1(I)LSh/d;

    invoke-virtual {p0, v4}, Lxe/d$b;->d(Lokio/ByteString;)V

    invoke-virtual {p0, v5}, Lxe/d$b;->d(Lokio/ByteString;)V

    invoke-direct {p0, v3}, Lxe/d$b;->c(Lxe/c;)V

    goto :goto_4

    :cond_9
    invoke-static {}, Lxe/d;->d()Lokio/ByteString;

    move-result-object v7

    invoke-virtual {v4, v7}, Lokio/ByteString;->S(Lokio/ByteString;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lxe/c;->h:Lokio/ByteString;
    ...
    invoke-virtual {p0, v6, v3, v1}, Lxe/d$b;->f(III)V
    ...
    invoke-virtual {p0, v6, v4, v8}, Lxe/d$b;->f(III)V
...
.method f(III)V
    ...
    iget-object p2, p0, Lxe/d$b;->a:LSh/d;
