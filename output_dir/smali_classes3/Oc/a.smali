...
.method private static b(LQc/f;III)LHc/b;
    .locals 9

    invoke-virtual {p0}, LQc/f;->a()LQc/b;
    ...
    invoke-virtual {p0, v6, p2}, LQc/b;->b(II)B

    move-result v8

    if-ne v8, v2, :cond_0

    invoke-virtual {v5, v7, v4, p3, p3}, LHc/b;->k(IIII)V
...
.method public a(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)LHc/b;
    ...
    :cond_1
    invoke-static {p1, p2, p5}, LQc/c;->n(Ljava/lang/String;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;Ljava/util/Map;)LQc/f;

    move-result-object p1

    invoke-static {p1, p3, p4, v0}, LOc/a;->b(LQc/f;III)LHc/b;
