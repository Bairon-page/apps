...
.method public static final a(JJLjava/util/List;Ljava/util/List;I)Landroid/graphics/Shader;
    ...
    invoke-static/range {p4 .. p5}, Lp0/X;->f(Ljava/util/List;Ljava/util/List;)V

    invoke-static {p4}, Lp0/X;->c(Ljava/util/List;)I
    ...
    invoke-static {p4, v1}, Lp0/X;->d(Ljava/util/List;I)[I

    move-result-object v7

    move-object/from16 v2, p5

    invoke-static {v2, p4, v1}, Lp0/X;->e(Ljava/util/List;Ljava/util/List;I)[F

    move-result-object v8

    invoke-static/range {p6 .. p6}, Lp0/Y;->a(I)Landroid/graphics/Shader$TileMode;
...
.method public static final b(JFLjava/util/List;Ljava/util/List;I)Landroid/graphics/Shader;
    ...
    invoke-static {p3, p4}, Lp0/X;->f(Ljava/util/List;Ljava/util/List;)V

    invoke-static {p3}, Lp0/X;->c(Ljava/util/List;)I
    ...
    invoke-static {p3, v0}, Lp0/X;->d(Ljava/util/List;I)[I

    move-result-object v5

    invoke-static {p4, p3, v0}, Lp0/X;->e(Ljava/util/List;Ljava/util/List;I)[F

    move-result-object v6

    invoke-static {p5}, Lp0/Y;->a(I)Landroid/graphics/Shader$TileMode;
...
.method public static final e(Ljava/util/List;Ljava/util/List;I)[F
    ...
    invoke-static {p0}, Lkotlin/collections/k;->d1(Ljava/util/Collection;)[F
    ...
    invoke-static {v4, v5}, Lp0/s0;->n(J)F
