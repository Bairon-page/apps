...
# direct methods
.method private static final a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;IILT0/A;LN0/w;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    .locals 17
    ...
    invoke-interface {v1, v0}, LT0/A;->b(I)I
    ...
    invoke-static {v4, v5}, LN0/z;->b(II)J
    ...
    invoke-direct {v8, v9, v10, v11, v7}, Lo0/i;-><init>(FFFF)V

    invoke-virtual {v3, v8}, Lo0/i;->r(Lo0/i;)Z

    move-result v7

    invoke-virtual {v8}, Lo0/i;->i()F

    move-result v9

    invoke-virtual {v8}, Lo0/i;->l()F

    move-result v10

    invoke-static {v3, v9, v10}, LT0/d;->c(Lo0/i;FF)Z

    move-result v9

    if-eqz v9, :cond_1

    invoke-virtual {v8}, Lo0/i;->j()F

    move-result v9

    invoke-virtual {v8}, Lo0/i;->e()F
    ...
    :goto_3
    invoke-virtual {v9, v5}, LN0/w;->c(I)Landroidx/compose/ui/text/style/ResolvedTextDirection;

    move-result-object v5

    sget-object v10, Landroidx/compose/ui/text/style/ResolvedTextDirection;->b:Landroidx/compose/ui/text/style/ResolvedTextDirection;
...
.method public static final b(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Landroidx/compose/ui/text/input/TextFieldValue;LT0/A;LN0/w;Landroid/graphics/Matrix;Lo0/i;Lo0/i;ZZZZ)Landroid/view/inputmethod/CursorAnchorInfo;
    .locals 9
    ...
    invoke-static {p0, v0, p2, p3, p5}, LT0/d;->d(Landroid/view/inputmethod/CursorAnchorInfo$Builder;ILT0/A;LN0/w;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static/range {v0 .. v5}, LT0/d;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;IILT0/A;LN0/w;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static {p0, p6}, LT0/b;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    ...
    invoke-static {p0, p3, p5}, LT0/c;->a(Landroid/view/inputmethod/CursorAnchorInfo$Builder;LN0/w;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
...
.method private static final c(Lo0/i;FF)Z
    .locals 2
...
.method private static final d(Landroid/view/inputmethod/CursorAnchorInfo$Builder;ILT0/A;LN0/w;Lo0/i;)Landroid/view/inputmethod/CursorAnchorInfo$Builder;
    .locals 9
    ...
    invoke-static {p4, v4, v0}, LT0/d;->c(Lo0/i;FF)Z
    ...
    invoke-static {p4, v4, v1}, LT0/d;->c(Lo0/i;FF)Z

    move-result p4

    invoke-virtual {p3, p1}, LN0/w;->c(I)Landroidx/compose/ui/text/style/ResolvedTextDirection;

    move-result-object p1

    sget-object p3, Landroidx/compose/ui/text/style/ResolvedTextDirection;->b:Landroidx/compose/ui/text/style/ResolvedTextDirection;
