...
# instance fields
.field final synthetic a:Landroidx/compose/animation/d;

.field final synthetic b:Landroidx/compose/animation/f;


# direct methods
.method constructor <init>(Landroidx/compose/animation/d;Landroidx/compose/animation/f;)V
    .locals 0

    iput-object p1, p0, Landroidx/compose/animation/EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$1;->a:Landroidx/compose/animation/d;

    iput-object p2, p0, Landroidx/compose/animation/EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$1;->b:Landroidx/compose/animation/f;
...
.method public final a(Landroidx/compose/animation/core/Transition$b;)Lu/D;
    ...
    iget-object p1, p0, Landroidx/compose/animation/EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$1;->a:Landroidx/compose/animation/d;

    invoke-virtual {p1}, Landroidx/compose/animation/d;->b()Lt/v;

    move-result-object p1

    invoke-virtual {p1}, Lt/v;->c()Lt/h;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lt/h;->b()Lu/D;
    ...
    :cond_0
    invoke-static {}, Landroidx/compose/animation/EnterExitTransitionKt;->b()Lu/X;
    ...
    iget-object p1, p0, Landroidx/compose/animation/EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$1;->b:Landroidx/compose/animation/f;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/animation/EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$1;->a(Landroidx/compose/animation/core/Transition$b;)Lu/D;
