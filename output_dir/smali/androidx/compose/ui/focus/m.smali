...
.method public static final a(Landroidx/compose/ui/focus/FocusTargetNode;ILandroidx/compose/ui/unit/LayoutDirection;)Landroidx/compose/ui/focus/FocusRequester;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->y()Landroidx/compose/ui/focus/FocusRequester;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->r()Landroidx/compose/ui/focus/FocusRequester;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->u()Landroidx/compose/ui/focus/FocusRequester;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->t()Landroidx/compose/ui/focus/FocusRequester;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->w()LZf/l;
    ...
    invoke-interface {p0}, Landroidx/compose/ui/focus/FocusProperties;->s()LZf/l;
...
.method public static final b(Landroidx/compose/ui/focus/FocusTargetNode;)Landroidx/compose/ui/focus/FocusTargetNode;
    ...
    new-array v5, v4, [Landroidx/compose/ui/b$c;

    const/4 v6, 0x0

    invoke-direct {v2, v5, v6}, LY/b;-><init>([Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p0}, LH0/g;->a(LY/b;Landroidx/compose/ui/b$c;)V

    goto :goto_0

    :cond_2
    invoke-virtual {v2, v5}, LY/b;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2, p0}, LY/b;->y(I)Ljava/lang/Object;
    ...
    invoke-direct {v5, v9, v6}, LY/b;-><init>([Ljava/lang/Object;I)V

    :cond_7
    if-eqz p0, :cond_8

    invoke-virtual {v5, p0}, LY/b;->b(Ljava/lang/Object;)Z

    move-object p0, v3

    :cond_8
    invoke-virtual {v5, v7}, LY/b;->b(Ljava/lang/Object;)Z
...
.method private static final c(Landroidx/compose/ui/focus/FocusTargetNode;)Landroidx/compose/ui/focus/FocusTargetNode;
    ...
    invoke-virtual {v3}, Landroidx/compose/ui/focus/FocusTargetNode;->q2()Landroidx/compose/ui/focus/FocusProperties;

    move-result-object v5

    invoke-interface {v5}, Landroidx/compose/ui/focus/FocusProperties;->x()Z
...
.method public static final d(Landroidx/compose/ui/focus/FocusTargetNode;)Lo0/i;
    .locals 2
    ...
    invoke-interface {v0, p0, v1}, LF0/k;->W(LF0/k;Z)Lo0/i;
...
.method public static final e(Landroidx/compose/ui/focus/FocusTargetNode;ILandroidx/compose/ui/unit/LayoutDirection;Lo0/i;LZf/l;)Ljava/lang/Boolean;
    .locals 4
    ...
    invoke-static {p0, p1, p4}, Landroidx/compose/ui/focus/OneDimensionalFocusSearchKt;->f(Landroidx/compose/ui/focus/FocusTargetNode;ILZf/l;)Z
    ...
    invoke-static {p0, p1, p3, p4}, Landroidx/compose/ui/focus/TwoDimensionalFocusSearchKt;->t(Landroidx/compose/ui/focus/FocusTargetNode;ILo0/i;LZf/l;)Ljava/lang/Boolean;
    ...
    invoke-static {p1}, Landroidx/compose/ui/focus/m;->c(Landroidx/compose/ui/focus/FocusTargetNode;)Landroidx/compose/ui/focus/FocusTargetNode;
    ...
    :cond_b
    invoke-interface {p4, v3}, LZf/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final f(Landroidx/compose/ui/focus/FocusTargetNode;)Landroidx/compose/ui/focus/FocusTargetNode;
    ...
    new-array v4, v3, [Landroidx/compose/ui/b$c;
    ...
    new-array v9, v3, [Landroidx/compose/ui/b$c;

    invoke-direct {v6, v9, v5}, LY/b;-><init>([Ljava/lang/Object;I)V
