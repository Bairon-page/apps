...
.method public static final a(Landroidx/compose/ui/b;LZf/p;Landroidx/compose/runtime/b;II)V
    .locals 7
    ...
    invoke-static/range {v1 .. v6}, Landroidx/compose/ui/layout/SubcomposeLayoutKt;->b(Landroidx/compose/ui/layout/SubcomposeLayoutState;Landroidx/compose/ui/b;LZf/p;Landroidx/compose/runtime/b;II)V
    ...
    invoke-direct {v0, p0, p1, p3, p4}, Landroidx/compose/ui/layout/SubcomposeLayoutKt$SubcomposeLayout$2;-><init>(Landroidx/compose/ui/b;LZf/p;II)V
...
.method public static final b(Landroidx/compose/ui/layout/SubcomposeLayoutState;Landroidx/compose/ui/b;LZf/p;Landroidx/compose/runtime/b;II)V
    .locals 7
    ...
    invoke-static {p3, v0}, LW/e;->a(Landroidx/compose/runtime/b;I)I

    move-result v1

    invoke-static {p3, v0}, LW/e;->d(Landroidx/compose/runtime/b;I)Landroidx/compose/runtime/e;
    ...
    sget-object v5, Landroidx/compose/ui/node/LayoutNode;->a0:Landroidx/compose/ui/node/LayoutNode$c;

    invoke-virtual {v5}, Landroidx/compose/ui/node/LayoutNode$c;->a()LZf/a;
    ...
    invoke-virtual {p0}, Landroidx/compose/ui/layout/SubcomposeLayoutState;->g()LZf/p;

    move-result-object v6

    invoke-static {v5, p0, v6}, LW/s0;->b(Landroidx/compose/runtime/b;Ljava/lang/Object;LZf/p;)V

    invoke-virtual {p0}, Landroidx/compose/ui/layout/SubcomposeLayoutState;->e()LZf/p;

    move-result-object v6

    invoke-static {v5, v2, v6}, LW/s0;->b(Landroidx/compose/runtime/b;Ljava/lang/Object;LZf/p;)V

    invoke-virtual {p0}, Landroidx/compose/ui/layout/SubcomposeLayoutState;->f()LZf/p;

    move-result-object v2

    invoke-static {v5, p2, v2}, LW/s0;->b(Landroidx/compose/runtime/b;Ljava/lang/Object;LZf/p;)V
    ...
    invoke-static {v5, v3, v4}, LW/s0;->b(Landroidx/compose/runtime/b;Ljava/lang/Object;LZf/p;)V
    ...
    invoke-interface {v5, v1, v2}, Landroidx/compose/runtime/b;->J(Ljava/lang/Object;LZf/p;)V
    ...
    invoke-static {v2, p3, v0}, LW/v;->g(LZf/a;Landroidx/compose/runtime/b;I)V
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/compose/ui/layout/SubcomposeLayoutKt$SubcomposeLayout$5;-><init>(Landroidx/compose/ui/layout/SubcomposeLayoutState;Landroidx/compose/ui/b;LZf/p;II)V

    invoke-interface {p1, p3}, LW/f0;->a(LZf/p;)V
