...
.method public bridge synthetic b(Landroidx/compose/ui/text/font/d;)Ljava/lang/Object;
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/compose/ui/text/font/AndroidFontLoader;->d(Landroidx/compose/ui/text/font/d;)Landroid/graphics/Typeface;
...
.method public c(Landroidx/compose/ui/text/font/d;LRf/c;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-direct {v0, p0, p2}, Landroidx/compose/ui/text/font/AndroidFontLoader$awaitLoad$1;-><init>(Landroidx/compose/ui/text/font/AndroidFontLoader;LRf/c;)V
    ...
    instance-of p2, p1, Landroidx/compose/ui/text/font/u;
    ...
    invoke-static {p2, v2, v0}, LS0/a;->b(Landroidx/compose/ui/text/font/u;Landroid/content/Context;LRf/c;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Landroidx/compose/ui/text/font/u;->e()LS0/g;

    move-result-object p1

    iget-object v0, v0, Landroidx/compose/ui/text/font/AndroidFontLoader;->a:Landroid/content/Context;

    invoke-static {p2, p1, v0}, Landroidx/compose/ui/text/font/t;->b(Landroid/graphics/Typeface;LS0/g;Landroid/content/Context;)Landroid/graphics/Typeface;
...
.method public d(Landroidx/compose/ui/text/font/d;)Landroid/graphics/Typeface;
    .locals 4

    instance-of v0, p1, Landroidx/compose/ui/text/font/u;

    const/4 v1, 0x0

    if-eqz v0, :cond_4

    invoke-interface {p1}, Landroidx/compose/ui/text/font/d;->a()I

    move-result v0

    sget-object v2, Landroidx/compose/ui/text/font/j;->a:Landroidx/compose/ui/text/font/j$a;

    invoke-virtual {v2}, Landroidx/compose/ui/text/font/j$a;->b()I

    move-result v3

    invoke-static {v0, v3}, Landroidx/compose/ui/text/font/j;->e(II)Z
    ...
    check-cast v0, Landroidx/compose/ui/text/font/u;

    iget-object v1, p0, Landroidx/compose/ui/text/font/AndroidFontLoader;->a:Landroid/content/Context;

    invoke-static {v0, v1}, LS0/a;->a(Landroidx/compose/ui/text/font/u;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    :cond_0
    invoke-virtual {v2}, Landroidx/compose/ui/text/font/j$a;->c()I
    ...
    invoke-static {v0, v2}, LS0/a;->a(Landroidx/compose/ui/text/font/u;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static {v0, p1, v1}, Landroidx/compose/ui/text/font/t;->b(Landroid/graphics/Typeface;LS0/g;Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    :cond_2
    invoke-virtual {v2}, Landroidx/compose/ui/text/font/j$a;->a()I
    ...
    invoke-static {p1}, Landroidx/compose/ui/text/font/j;->g(I)Ljava/lang/String;
