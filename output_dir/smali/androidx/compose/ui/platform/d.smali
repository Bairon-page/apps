...
.method private final i(ILandroidx/compose/ui/text/style/ResolvedTextDirection;)I
    ...
    iget-object v0, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
    ...
    :cond_0
    invoke-virtual {v0, p1}, LN0/w;->u(I)I

    move-result v0

    iget-object v3, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
    ...
    :cond_1
    invoke-virtual {v3, v0}, LN0/w;->y(I)Landroidx/compose/ui/text/style/ResolvedTextDirection;

    move-result-object v0

    if-eq p2, v0, :cond_3

    iget-object p2, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
    ...
    invoke-static {p2, p1, v0, v1, v2}, LN0/w;->p(LN0/w;IZILjava/lang/Object;)I
...
.method public a(I)[I
    ...
    :cond_2
    invoke-virtual {v0}, Landroidx/compose/ui/semantics/SemanticsNode;->i()Lo0/i;

    move-result-object v0

    invoke-virtual {v0}, Lo0/i;->h()F
    ...
    invoke-static {v2, p1}, Lfg/j;->d(II)I

    move-result p1

    iget-object v2, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
    ...
    :cond_3
    invoke-virtual {v2, p1}, LN0/w;->q(I)I

    move-result v2

    iget-object v4, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
    ...
    :cond_4
    invoke-virtual {v4, v2}, LN0/w;->v(I)F
    ...
    :cond_6
    invoke-virtual {v4}, LN0/w;->n()I

    move-result v4

    add-int/lit8 v4, v4, -0x1

    invoke-virtual {v0, v4}, LN0/w;->v(I)F
    ...
    :goto_0
    invoke-virtual {v1, v2}, LN0/w;->r(F)I
...
.method public b(I)[I
    ...
    :goto_0
    invoke-virtual {v1, v4}, LN0/w;->r(F)I
...
.method public final j(Ljava/lang/String;LN0/w;Landroidx/compose/ui/semantics/SemanticsNode;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroidx/compose/ui/platform/a;->f(Ljava/lang/String;)V

    iput-object p2, p0, Landroidx/compose/ui/platform/d;->c:LN0/w;
