...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/compose/ui/platform/N0;->a:Lo0/i;

    return-void
.end method

.method public static final a(Ljava/util/List;I)Landroidx/compose/ui/platform/K0;
    .locals 3
    ...
    check-cast v2, Landroidx/compose/ui/platform/K0;

    invoke-virtual {v2}, Landroidx/compose/ui/platform/K0;->d()I
...
.method public static final b(LL0/n;)Landroidx/collection/m;
    .locals 6

    invoke-virtual {p0}, LL0/n;->a()Landroidx/compose/ui/semantics/SemanticsNode;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/compose/ui/semantics/SemanticsNode;->i()Lo0/i;
    ...
    invoke-static {v2, p0, v0, p0, v1}, Landroidx/compose/ui/platform/N0;->c(Landroid/graphics/Region;Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/collection/z;Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Region;)V
...
.method private static final c(Landroid/graphics/Region;Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/collection/z;Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Region;)V
    .locals 9
    ...
    :cond_4
    invoke-virtual {p3}, Landroidx/compose/ui/semantics/SemanticsNode;->v()Lo0/i;
    ...
    invoke-direct {v2, p3, v8}, Landroidx/compose/ui/platform/M0;-><init>(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Rect;)V

    invoke-virtual {p2, v0, v2}, Landroidx/collection/z;->t(ILjava/lang/Object;)V
    ...
    invoke-static {p0, p1, p2, v1, p4}, Landroidx/compose/ui/platform/N0;->c(Landroid/graphics/Region;Landroidx/compose/ui/semantics/SemanticsNode;Landroidx/collection/z;Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Region;)V
    ...
    :cond_6
    invoke-static {p3}, Landroidx/compose/ui/platform/N0;->f(Landroidx/compose/ui/semantics/SemanticsNode;)Z
    ...
    :cond_8
    sget-object p0, Landroidx/compose/ui/platform/N0;->a:Lo0/i;
    ...
    invoke-direct {p1, p3, p4}, Landroidx/compose/ui/platform/M0;-><init>(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Rect;)V

    invoke-virtual {p2, v0, p1}, Landroidx/collection/z;->t(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, p3, p1}, Landroidx/compose/ui/platform/M0;-><init>(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/graphics/Rect;)V

    invoke-virtual {p2, v0, p0}, Landroidx/collection/z;->t(ILjava/lang/Object;)V
...
.method public static final d(LL0/j;)Ljava/lang/Float;
    .locals 2
    ...
    invoke-virtual {v1}, LL0/i;->h()Landroidx/compose/ui/semantics/SemanticsPropertyKey;
...
.method public static final e(LL0/j;)LN0/w;
    .locals 2
    ...
    invoke-virtual {v1}, LL0/i;->i()Landroidx/compose/ui/semantics/SemanticsPropertyKey;
...
.method public static final h(Landroidx/compose/ui/platform/O;I)Landroid/view/View;
    .locals 3

    invoke-virtual {p0}, Landroidx/compose/ui/platform/O;->getLayoutNodeToHolder()Ljava/util/HashMap;
    ...
    invoke-virtual {v2}, Landroidx/compose/ui/node/LayoutNode;->p0()I
...
.method public static final i(I)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, LL0/g;->k(II)Z
    ...
    invoke-static {p0, v0}, LL0/g;->k(II)Z
