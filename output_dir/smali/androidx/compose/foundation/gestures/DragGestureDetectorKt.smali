...
.method public static final synthetic a(Landroidx/compose/ui/input/pointer/c;J)Z
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt;->g(Landroidx/compose/ui/input/pointer/c;J)Z
...
.method public static final b(LB0/b;JLRf/c;)Ljava/lang/Object;
    .locals 17
    ...
    invoke-direct {v3, v2}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$awaitDragOrCancellation$1;-><init>(LRf/c;)V
    ...
    invoke-interface/range {p0 .. p0}, LB0/b;->D0()Landroidx/compose/ui/input/pointer/c;

    move-result-object v2

    invoke-static {v2, v0, v1}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt;->g(Landroidx/compose/ui/input/pointer/c;J)Z
    ...
    invoke-static {v0, v7, v3, v6, v7}, LB0/b;->P0(LB0/b;Landroidx/compose/ui/input/pointer/PointerEventPass;LRf/c;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v12, v13, v14, v15}, LB0/r;->d(JJ)Z
    ...
    :cond_7
    invoke-static {v11}, LB0/l;->d(LB0/s;)Z
    ...
    :cond_b
    invoke-static {v11}, LB0/l;->j(LB0/s;)Z
...
.method public static final c(LB0/b;JLRf/c;)Ljava/lang/Object;
    .locals 9
    ...
    invoke-direct {v0, p3}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$awaitLongPressOrCancellation$1;-><init>(LRf/c;)V
    ...
    invoke-static {p3, p1, p2}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt;->g(Landroidx/compose/ui/input/pointer/c;J)Z
    ...
    invoke-static {v7, v8, p1, p2}, LB0/r;->d(JJ)Z
    ...
    invoke-interface {v2}, Landroidx/compose/ui/platform/V0;->c()J
    ...
    invoke-direct {v2, p3, p2, v4}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$awaitLongPressOrCancellation$2;-><init>(Lkotlin/jvm/internal/Ref$ObjectRef;Lkotlin/jvm/internal/Ref$ObjectRef;LRf/c;)V
    ...
    invoke-interface {p0, v5, v6, v2, v0}, LB0/b;->H0(JLZf/p;LRf/c;)Ljava/lang/Object;
...
.method public static final d(LB0/A;LZf/l;LZf/a;LZf/a;LZf/p;LRf/c;)Ljava/lang/Object;
    .locals 8

    new-instance v1, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$detectDragGestures$5;

    invoke-direct {v1, p1}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$detectDragGestures$5;-><init>(LZf/l;)V

    new-instance v2, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$detectDragGestures$6;

    invoke-direct {v2, p2}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$detectDragGestures$6;-><init>(LZf/a;)V
    ...
    invoke-static/range {v0 .. v7}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt;->e(LB0/A;LZf/q;LZf/l;LZf/a;LZf/a;Landroidx/compose/foundation/gestures/Orientation;LZf/p;LRf/c;)Ljava/lang/Object;
...
.method public static final e(LB0/A;LZf/q;LZf/l;LZf/a;LZf/a;Landroidx/compose/foundation/gestures/Orientation;LZf/p;LRf/c;)Ljava/lang/Object;
    .locals 10
    ...
    invoke-static {p0, v9, v1}, Landroidx/compose/foundation/gestures/ForEachGestureKt;->c(LB0/A;LZf/p;LRf/c;)Ljava/lang/Object;
...
.method public static final f(LB0/b;JLZf/l;LRf/c;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-direct {v0, p4}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt$drag$1;-><init>(LRf/c;)V
    ...
    invoke-static {p0, p1, p2, v0}, Landroidx/compose/foundation/gestures/DragGestureDetectorKt;->b(LB0/b;JLRf/c;)Ljava/lang/Object;
    ...
    :cond_4
    invoke-static {p4}, LB0/l;->d(LB0/s;)Z
...
.method private static final g(Landroidx/compose/ui/input/pointer/c;J)Z
    .locals 6
    ...
    invoke-static {v4, v5, p1, p2}, LB0/r;->d(JJ)Z
...
.method public static final h(Landroidx/compose/ui/platform/V0;I)F
    .locals 1

    sget-object v0, LB0/D;->a:LB0/D$a;

    invoke-virtual {v0}, LB0/D$a;->b()I

    move-result v0

    invoke-static {p1, v0}, LB0/D;->g(II)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-interface {p0}, Landroidx/compose/ui/platform/V0;->g()F
