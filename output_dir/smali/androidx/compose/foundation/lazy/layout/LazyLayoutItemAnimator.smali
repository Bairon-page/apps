...
.field private b:Landroidx/compose/foundation/lazy/layout/f;
...
.field private j:LH0/m;

.field private final k:Landroidx/compose/ui/b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;
...
.method public static final synthetic a(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;)I
    .locals 0

    invoke-direct {p0, p1}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->f(LC/n;)I
...
.method public static final synthetic c(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)LH0/m;
    .locals 0

    iget-object p0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->j:LH0/m;

    return-object p0
.end method

.method public static final synthetic d(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LH0/m;)V
    .locals 0

    iput-object p1, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->j:LH0/m;

    return-void
.end method

.method private final f(LC/n;)I
    .locals 2

    const/4 v0, 0x0

    invoke-interface {p1, v0}, LC/n;->j(I)J

    move-result-wide v0

    invoke-interface {p1}, LC/n;->f()Z
...
.method private final g(LC/n;)Z
    .locals 4

    invoke-interface {p1}, LC/n;->d()I
    ...
    invoke-interface {p1, v2}, LC/n;->i(I)Ljava/lang/Object;

    move-result-object v3

    invoke-static {v3}, LC/i;->b(Ljava/lang/Object;)LC/c;
...
.method private final k(LC/n;ILandroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;)V
    .locals 11
    ...
    invoke-static/range {v1 .. v6}, La1/n;->g(JIIILjava/lang/Object;)J
    ...
    invoke-interface {p1, v3}, LC/n;->j(I)J

    move-result-wide v9

    invoke-static {v9, v10, v7, v8}, La1/n;->m(JJ)J

    move-result-wide v9

    invoke-static {v1, v2, v9, v10}, La1/n;->n(JJ)J
...
.method static synthetic l(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;ILandroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;ILjava/lang/Object;)V
    .locals 0
    ...
    iget-object p3, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;

    invoke-interface {p1}, LC/n;->getKey()Ljava/lang/Object;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroidx/collection/O;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->k(LC/n;ILandroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;)V
...
.method private final n(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;
...
.method private final p(LC/n;Z)V
    .locals 12
    ...
    invoke-static {v8, v9, v6, v7}, La1/n;->i(JJ)Z

    move-result v3

    if-nez v3, :cond_0

    invoke-static {v6, v7, v8, v9}, La1/n;->m(JJ)J
...
.method static synthetic q(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;ZILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->p(LC/n;Z)V

    return-void
.end method

.method private final r([ILC/n;)I
    .locals 5
...
.method public final i()J
    ...
    invoke-static {v9, v10}, La1/r;->g(J)I
    ...
    invoke-static {v5, v6}, La1/r;->f(J)I
    ...
    invoke-static {v7, v0}, La1/s;->a(II)J
...
.method public final j()Landroidx/compose/ui/b;
    .locals 1

    iget-object v0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->k:Landroidx/compose/ui/b;

    return-object v0
.end method

.method public final m(IIILjava/util/List;Landroidx/compose/foundation/lazy/layout/f;LC/o;ZZIZIILoh/y;Lp0/E0;)V
    .locals 35
    ...
    iget-object v13, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->b:Landroidx/compose/foundation/lazy/layout/f;

    iput-object v10, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->b:Landroidx/compose/foundation/lazy/layout/f;
    ...
    invoke-direct {v6, v3}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->g(LC/n;)Z
    ...
    :cond_1
    iget-object v1, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;

    invoke-virtual {v1}, Landroidx/collection/O;->f()Z
    ...
    invoke-static/range {p4 .. p4}, Lkotlin/collections/k;->s0(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-interface {v2}, LC/n;->getIndex()I
    ...
    invoke-static {v14, v0}, La1/o;->a(II)J
    ...
    :cond_4
    invoke-static {v0, v14}, La1/o;->a(II)J
    ...
    :goto_5
    iget-object v0, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;

    iget-object v4, v0, Landroidx/collection/O;->b:[Ljava/lang/Object;
    ...
    invoke-interface {v5}, LC/n;->getKey()Ljava/lang/Object;

    move-result-object v14

    invoke-virtual {v12, v14}, Landroidx/collection/MutableScatterSet;->x(Ljava/lang/Object;)Z

    invoke-direct {v6, v5}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->g(LC/n;)Z

    move-result v12

    if-eqz v12, :cond_19

    iget-object v12, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;
    ...
    invoke-interface {v13, v14}, Landroidx/compose/foundation/lazy/layout/f;->b(Ljava/lang/Object;)I
    ...
    invoke-static/range {v24 .. v32}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->l(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;LC/n;Loh/y;Lp0/E0;IIIILjava/lang/Object;)V
    ...
    invoke-virtual {v12, v7, v8}, Landroidx/collection/H;->s(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-interface {v5}, LC/n;->getIndex()I
    ...
    invoke-interface {v5, v7}, LC/n;->j(I)J

    move-result-wide v24

    invoke-interface {v5}, LC/n;->f()Z

    move-result v7

    if-eqz v7, :cond_10

    invoke-static/range {v24 .. v25}, La1/n;->k(J)I
    ...
    :cond_10
    invoke-static/range {v24 .. v25}, La1/n;->j(J)I

    move-result v7

    :goto_f
    invoke-direct {v6, v5, v7, v8}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->k(LC/n;ILandroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;)V
    ...
    invoke-static {v9, v10, v13, v14}, La1/n;->i(JJ)Z
    ...
    invoke-static {v9, v10, v2, v3}, La1/n;->n(JJ)J
    ...
    iget-object v10, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->j:LH0/m;

    if-eqz v10, :cond_16

    invoke-static {v10}, LH0/n;->a(LH0/m;)V

    sget-object v10, LNf/u;->a:LNf/u;
    ...
    invoke-static {v6, v5, v0, v7, v8}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->q(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;ZILjava/lang/Object;)V
    ...
    invoke-direct {v1, v8}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$d;-><init>(Landroidx/compose/foundation/lazy/layout/f;)V
    ...
    invoke-direct {v6, v7, v13}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->r([ILC/n;)I
    ...
    invoke-static/range {v0 .. v5}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->l(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;ILandroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;ILjava/lang/Object;)V
    ...
    invoke-static {v6, v13, v0, v1, v2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->q(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;ZILjava/lang/Object;)V
    ...
    invoke-static/range {v28 .. v33}, Lkotlin/collections/d;->v([IIIIILjava/lang/Object;)V
    ...
    invoke-direct {v1, v8}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$b;-><init>(Landroidx/compose/foundation/lazy/layout/f;)V
    ...
    invoke-virtual {v12, v10}, Landroidx/collection/O;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v15, v10}, Landroidx/compose/foundation/lazy/layout/f;->b(Ljava/lang/Object;)I
    ...
    iget-object v1, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->j:LH0/m;
    ...
    invoke-virtual {v12}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->b()La1/b;
    ...
    invoke-interface/range {v26 .. v31}, LC/o;->a(IIIJ)LC/n;

    move-result-object v0

    const/4 v1, 0x1

    invoke-interface {v0, v1}, LC/n;->e(Z)V
    ...
    invoke-interface {v8, v10}, Landroidx/compose/foundation/lazy/layout/f;->b(Ljava/lang/Object;)I
    ...
    invoke-virtual/range {v26 .. v32}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->k(LC/n;Loh/y;Lp0/E0;III)V
    ...
    invoke-direct {v1, v15}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$e;-><init>(Landroidx/compose/foundation/lazy/layout/f;)V
    ...
    iget-object v3, v6, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a:Landroidx/collection/H;

    invoke-interface {v2}, LC/n;->getKey()Ljava/lang/Object;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroidx/collection/O;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v6, v4, v2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->r([ILC/n;)I

    move-result v5

    if-eqz p8, :cond_38

    invoke-static/range {p4 .. p4}, Lkotlin/collections/k;->q0(Ljava/util/List;)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, LC/n;

    invoke-direct {v6, v8}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->h(LC/n;)I
    ...
    invoke-interface {v2, v8, v3, v5, v9}, LC/n;->g(IIII)V

    const/4 v3, 0x1

    if-eqz p7, :cond_39

    invoke-direct {v6, v2, v3}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->p(LC/n;Z)V
    ...
    invoke-static/range {v10 .. v15}, Lkotlin/collections/d;->v([IIIIILjava/lang/Object;)V
    ...
    invoke-direct {v2, v1}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$c;-><init>(Landroidx/compose/foundation/lazy/layout/f;)V

    invoke-static {v0, v2}, Lkotlin/collections/k;->A(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    invoke-virtual {v3, v8}, Landroidx/collection/O;->c(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static/range {p4 .. p4}, Lkotlin/collections/k;->B0(Ljava/util/List;)Ljava/lang/Object;

    move-result-object v10

    check-cast v10, LC/n;

    invoke-direct {v6, v10}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->h(LC/n;)I
    ...
    invoke-interface {v2, v10, v3, v5, v9}, LC/n;->g(IIII)V
...
.method public final o()V
    ...
    :cond_5
    sget-object v0, Landroidx/compose/foundation/lazy/layout/f;->a:Landroidx/compose/foundation/lazy/layout/f$a;

    iput-object v0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->b:Landroidx/compose/foundation/lazy/layout/f;
