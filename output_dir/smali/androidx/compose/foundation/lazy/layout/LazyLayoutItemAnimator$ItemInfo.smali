...
.method public constructor <init>(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)V
    ...
    invoke-static {}, LC/i;->a()[Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation;
...
.method public static synthetic l(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;LC/n;Loh/y;Lp0/E0;IIIILjava/lang/Object;)V
    .locals 7
    ...
    invoke-static {p6, p1}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->a(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;LC/n;)I
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->k(LC/n;Loh/y;Lp0/E0;III)V
...
.method public final b()La1/b;
    ...
    iget-object v0, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->b:La1/b;
...
.method public final k(LC/n;Loh/y;Lp0/E0;III)V
    .locals 3

    invoke-direct {p0}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->h()Z
    ...
    :cond_3
    invoke-interface {p1}, LC/n;->b()J

    move-result-wide p4

    invoke-static {p4, p5}, La1/b;->a(J)La1/b;

    move-result-object p4

    iput-object p4, p0, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator$ItemInfo;->b:La1/b;
    ...
    invoke-interface {p1, p6}, LC/n;->i(I)Ljava/lang/Object;

    move-result-object v0

    invoke-static {v0}, LC/i;->b(Ljava/lang/Object;)LC/c;
    ...
    invoke-direct {v1, p2, p3, v2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation;-><init>(Loh/y;Lp0/E0;LZf/a;)V
    ...
    :cond_6
    invoke-virtual {v0}, LC/c;->l2()Lu/D;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation;->C(Lu/D;)V

    invoke-virtual {v0}, LC/c;->n2()Lu/D;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation;->I(Lu/D;)V

    invoke-virtual {v0}, LC/c;->m2()Lu/D;

    move-result-object v0

    invoke-virtual {v1, v0}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimation;->D(Lu/D;)V
