...
.field private E:Landroidx/transition/w;

.field private F:Landroidx/transition/w;
...
.field private V:Landroidx/collection/a;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    new-instance v1, Landroidx/transition/w;

    invoke-direct {v1}, Landroidx/transition/w;-><init>()V

    iput-object v1, p0, Landroidx/transition/k;->F:Landroidx/transition/w;

    iput-object v0, p0, Landroidx/transition/k;->G:Landroidx/transition/t;
...
.method private static D()Landroidx/collection/a;
    .locals 2
...
.method private Q(Landroidx/collection/a;Landroidx/collection/a;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    .locals 7
...
.method private R(Landroidx/collection/a;Landroidx/collection/a;)V
    .locals 4
    ...
    invoke-virtual {p1, v0}, Landroidx/collection/S;->k(I)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v0}, Landroidx/collection/S;->m(I)Ljava/lang/Object;
...
.method private S(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/t;Landroidx/collection/t;)V
    .locals 7

    invoke-virtual {p3}, Landroidx/collection/t;->n()I
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/t;->o(I)Ljava/lang/Object;
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/t;->j(I)J

    move-result-wide v3

    invoke-virtual {p4, v3, v4}, Landroidx/collection/t;->g(J)Ljava/lang/Object;
...
.method private T(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;)V
    .locals 7

    invoke-virtual {p3}, Landroidx/collection/S;->size()I
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/S;->o(I)Ljava/lang/Object;
    ...
    invoke-virtual {p3, v1}, Landroidx/collection/S;->k(I)Ljava/lang/Object;
...
.method private U(Landroidx/transition/w;Landroidx/transition/w;)V
    .locals 5
    ...
    invoke-direct {v0, v1}, Landroidx/collection/a;-><init>(Landroidx/collection/S;)V

    new-instance v1, Landroidx/collection/a;

    iget-object v2, p2, Landroidx/transition/w;->a:Landroidx/collection/a;

    invoke-direct {v1, v2}, Landroidx/collection/a;-><init>(Landroidx/collection/S;)V
    ...
    :cond_0
    iget-object v3, p1, Landroidx/transition/w;->c:Landroidx/collection/t;

    iget-object v4, p2, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-direct {p0, v0, v1, v3, v4}, Landroidx/transition/k;->S(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/t;Landroidx/collection/t;)V
    ...
    invoke-direct {p0, v0, v1, v3, v4}, Landroidx/transition/k;->Q(Landroidx/collection/a;Landroidx/collection/a;Landroid/util/SparseArray;Landroid/util/SparseArray;)V
    ...
    invoke-direct {p0, v0, v1, v3, v4}, Landroidx/transition/k;->T(Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;Landroidx/collection/a;)V

    goto :goto_1

    :cond_3
    invoke-direct {p0, v0, v1}, Landroidx/transition/k;->R(Landroidx/collection/a;Landroidx/collection/a;)V
    ...
    :cond_4
    invoke-direct {p0, v0, v1}, Landroidx/transition/k;->e(Landroidx/collection/a;Landroidx/collection/a;)V
...
.method private V(Landroidx/transition/k;Landroidx/transition/k$g;Z)V
    ...
    invoke-interface {p2, v4, p1, p3}, Landroidx/transition/k$g;->e(Landroidx/transition/k$f;Landroidx/transition/k;Z)V
...
.method private c0(Landroid/animation/Animator;Landroidx/collection/a;)V
    .locals 1
...
.method private e(Landroidx/collection/a;Landroidx/collection/a;)V
    .locals 5
    ...
    invoke-virtual {p1, v1}, Landroidx/collection/S;->o(I)Ljava/lang/Object;
    ...
    :cond_1
    :goto_1
    invoke-virtual {p2}, Landroidx/collection/S;->size()I

    move-result p1

    if-ge v0, p1, :cond_3

    invoke-virtual {p2, v0}, Landroidx/collection/S;->o(I)Ljava/lang/Object;
...
.method private static g(Landroidx/transition/w;Landroid/view/View;Landroidx/transition/v;)V
    .locals 3
    ...
    :cond_1
    :goto_0
    invoke-static {p1}, Landroidx/core/view/a0;->G(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p2, v0}, Landroidx/collection/S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p2, p1}, Landroidx/collection/S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-virtual {p2, v1, v2}, Landroidx/collection/t;->h(J)I

    move-result p2

    if-ltz p2, :cond_4

    iget-object p1, p0, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-virtual {p1, v1, v2}, Landroidx/collection/t;->g(J)Ljava/lang/Object;
    ...
    iget-object p0, p0, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-virtual {p0, v1, v2, v0}, Landroidx/collection/t;->k(JLjava/lang/Object;)V
    ...
    invoke-virtual {p0, v1, v2, p1}, Landroidx/collection/t;->k(JLjava/lang/Object;)V
...
.method private j(Landroid/view/View;Z)V
    ...
    iget-object v3, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    invoke-static {v3, p1, v1}, Landroidx/transition/k;->g(Landroidx/transition/w;Landroid/view/View;Landroidx/transition/v;)V

    goto :goto_2

    :cond_6
    iget-object v3, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
...
# virtual methods
.method public A()Landroidx/transition/s;
    .locals 1
...
.method public final B()Landroidx/transition/k;
    ...
    iget-object v0, p0, Landroidx/transition/k;->G:Landroidx/transition/t;
...
.method public L(Landroid/view/View;Z)Landroidx/transition/v;
    ...
    iget-object p2, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    goto :goto_0

    :cond_1
    iget-object p2, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
...
.method Y(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    iget-object v1, p0, Landroidx/transition/k;->F:Landroidx/transition/w;

    invoke-direct {p0, v0, v1}, Landroidx/transition/k;->U(Landroidx/transition/w;Landroidx/transition/w;)V

    invoke-static {}, Landroidx/transition/k;->D()Landroidx/collection/a;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/collection/S;->size()I
    ...
    invoke-virtual {v0, v1}, Landroidx/collection/S;->k(I)Ljava/lang/Object;
    ...
    iget-object v9, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
    ...
    :cond_5
    iget-object v6, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    iget-object v7, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
...
.method protected d0()V
    ...
    invoke-direct {p0, v2, v0}, Landroidx/transition/k;->c0(Landroid/animation/Animator;Landroidx/collection/a;)V
...
.method public g0(Landroid/animation/TimeInterpolator;)Landroidx/transition/k;
    .locals 0
...
.method public abstract i(Landroidx/transition/v;)V
.end method
...
.method public j0(J)Landroidx/transition/k;
    .locals 0
...
.method m(Landroid/view/ViewGroup;Z)V
    ...
    iget-object v4, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    invoke-static {v4, v2, v3}, Landroidx/transition/k;->g(Landroidx/transition/w;Landroid/view/View;Landroidx/transition/v;)V

    goto :goto_3

    :cond_5
    iget-object v4, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
    ...
    invoke-static {v3, v0, v2}, Landroidx/transition/k;->g(Landroidx/transition/w;Landroid/view/View;Landroidx/transition/v;)V
    ...
    iget-object p1, p0, Landroidx/transition/k;->V:Landroidx/collection/a;
    ...
    iget-object v2, p0, Landroidx/transition/k;->V:Landroidx/collection/a;

    invoke-virtual {v2, v0}, Landroidx/collection/S;->k(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v1}, Landroidx/collection/S;->o(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v2, v0}, Landroidx/collection/S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method n(Z)V
    ...
    iget-object p1, p0, Landroidx/transition/k;->E:Landroidx/transition/w;

    iget-object p1, p1, Landroidx/transition/w;->a:Landroidx/collection/a;

    invoke-virtual {p1}, Landroidx/collection/S;->clear()V
    ...
    iget-object p1, p1, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-virtual {p1}, Landroidx/collection/t;->b()V

    goto :goto_0

    :cond_0
    iget-object p1, p0, Landroidx/transition/k;->F:Landroidx/transition/w;
...
.method public o()Landroidx/transition/k;
    ...
    iput-object v1, v0, Landroidx/transition/k;->E:Landroidx/transition/w;

    new-instance v1, Landroidx/transition/w;

    invoke-direct {v1}, Landroidx/transition/w;-><init>()V

    iput-object v1, v0, Landroidx/transition/k;->F:Landroidx/transition/w;
...
.method q(Landroid/view/ViewGroup;Landroidx/transition/w;Landroidx/transition/w;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v5, v6, Landroidx/transition/w;->a:Landroidx/collection/a;
    ...
    invoke-virtual {v8}, Landroidx/collection/S;->size()I
    ...
    invoke-virtual {v8, v2}, Landroidx/collection/S;->k(I)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v11, v10}, Landroidx/collection/S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected r()V
    ...
    iget-object v3, v3, Landroidx/transition/w;->c:Landroidx/collection/t;

    invoke-virtual {v3}, Landroidx/collection/t;->n()I
    ...
    invoke-virtual {v3, v0}, Landroidx/collection/t;->o(I)Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Landroidx/transition/k;->l0(Ljava/lang/String;)Ljava/lang/String;
