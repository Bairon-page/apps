...
.method private j()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/core/graphics/i;->h:Ljava/lang/reflect/Constructor;
...
.method private n(Ljava/lang/Object;)Z
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/core/graphics/i;->k:Ljava/lang/reflect/Method;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lo1/g$b;I)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-virtual {p0, p3, p4}, Landroidx/core/graphics/l;->f([Lo1/g$b;I)Lo1/g$b;
    ...
    :try_start_0
    invoke-virtual {p3}, Lo1/g$b;->d()Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1, p3, p2}, Landroidx/core/graphics/m;->f(Landroid/content/Context;[Lo1/g$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lo1/g$b;->d()Landroid/net/Uri;
    ...
    :cond_5
    invoke-virtual {v4}, Lo1/g$b;->c()I

    move-result v6

    invoke-virtual {v4}, Lo1/g$b;->e()I

    move-result v7

    invoke-virtual {v4}, Lo1/g$b;->f()Z
...
.method protected abstract h(Ljava/lang/Object;)Landroid/graphics/Typeface;
.end method
...
.method protected abstract s(Ljava/lang/Class;)Ljava/lang/reflect/Method;
.end method
