...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Lr1/o;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lr1/o;->e()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v0, v1}, Lr1/n;->H0(Z)V

    invoke-static {p1}, Landroidx/core/view/a0;->O(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lr1/n;->s0(Z)V

    invoke-static {p1}, Landroidx/core/view/a0;->n(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lr1/n;->B0(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/a0;->F(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lr1/n;->M0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Lr1/n;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Lr1/n;->e(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lr1/n;->b(Lr1/n$a;)V
