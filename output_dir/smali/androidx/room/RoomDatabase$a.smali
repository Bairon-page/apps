...
.method public varargs b([Ld2/b;)Landroidx/room/RoomDatabase$a;
    .locals 5
    ...
    invoke-virtual {v0, p1}, Landroidx/room/RoomDatabase$d;->b([Ld2/b;)V
...
.method public d()Landroidx/room/RoomDatabase;
    ...
    :cond_4
    iget-object v1, v0, Landroidx/room/RoomDatabase$a;->i:Lg2/h$c;
    ...
    invoke-direct {v4, v1, v3}, Landroidx/room/d;-><init>(Lg2/h$c;Landroidx/room/c;)V
    ...
    invoke-direct {v4, v3, v7, v9, v1}, Landroidx/room/y;-><init>(Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;Lg2/h$c;)V
    ...
    invoke-virtual {v3, v4}, Landroidx/room/RoomDatabase$JournalMode;->d(Landroid/content/Context;)Landroidx/room/RoomDatabase$JournalMode;
    ...
    invoke-direct/range {v3 .. v22}, Landroidx/room/f;-><init>(Landroid/content/Context;Ljava/lang/String;Lg2/h$c;Landroidx/room/RoomDatabase$d;Ljava/util/List;ZLandroidx/room/RoomDatabase$JournalMode;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Landroid/content/Intent;ZZLjava/util/Set;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;Landroidx/room/RoomDatabase$e;Ljava/util/List;Ljava/util/List;)V
...
.method public f(Lg2/h$c;)Landroidx/room/RoomDatabase$a;
    .locals 0

    iput-object p1, p0, Landroidx/room/RoomDatabase$a;->i:Lg2/h$c;
