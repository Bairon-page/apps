...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->A:Landroidx/appcompat/widget/O;
...
.method private C()Landroidx/appcompat/widget/P;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/P;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->A:Landroidx/appcompat/widget/O;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/P;->U(Landroidx/appcompat/widget/O;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/N;->D(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->C:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/N;->G(I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/N;->I(I)V
...
.method private I(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->C()Landroidx/appcompat/widget/P;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/N;->n(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/N;->F(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->C:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/N;->G(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/P;->V(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/P;->S(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/N;->D(Landroid/view/View;)V

    iget v8, p0, Landroidx/appcompat/view/menu/b;->C:I
    ...
    :goto_3
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/N;->g(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/N;->N(Z)V

    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/N;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/N;->j(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/N;->H(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/P;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->x:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/N;->b()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/N;->p()Landroid/widget/ListView;
...
.method public c()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;
...
.method public d(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/P;->T(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/N;->E(I)V
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;

    invoke-virtual {v3}, Landroidx/appcompat/widget/N;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;

    invoke-virtual {v2}, Landroidx/appcompat/widget/N;->dismiss()V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/P;

    invoke-virtual {v4}, Landroidx/appcompat/widget/N;->c()Z
