...
.field private static final h:Landroidx/collection/S;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/s;->h:Landroidx/collection/S;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/a0;->n0(Landroid/view/View;Z)V
    ...
    invoke-static {p2, v2}, Landroidx/core/view/a0;->p0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, Landroidx/appcompat/app/s;->h:Landroidx/collection/S;

    invoke-virtual {v0, p2}, Landroidx/collection/S;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v1}, Landroidx/collection/S;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method protected p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/B;
    .locals 1
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/j;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/B;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/n;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/x;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/s;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
