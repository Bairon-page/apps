...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/a0;)V
    ...
    iput-boolean v5, p0, Landroidx/appcompat/widget/w;->m:Z
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/w;->l:Landroid/graphics/Typeface;
    ...
    :cond_7
    iget v3, p0, Landroidx/appcompat/widget/w;->k:I
    ...
    new-instance v7, Landroidx/appcompat/widget/w$a;

    invoke-direct {v7, p0, v3, v6, p1}, Landroidx/appcompat/widget/w$a;-><init>(Landroidx/appcompat/widget/w;IILjava/lang/ref/WeakReference;)V

    :try_start_0
    iget p1, p0, Landroidx/appcompat/widget/w;->j:I

    invoke-virtual {p2, v0, p1, v7}, Landroidx/appcompat/widget/a0;->j(IILandroidx/core/content/res/h$e;)Landroid/graphics/Typeface;
    ...
    :goto_2
    invoke-static {p1, v3, v6}, Landroidx/appcompat/widget/w$e;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
    ...
    :goto_5
    invoke-static {p1, p2, v4}, Landroidx/appcompat/widget/w$e;->a(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/i;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;[I)V

    :cond_0
    return-void
.end method

.method private static d(Landroid/content/Context;Landroidx/appcompat/widget/i;I)Landroidx/appcompat/widget/Y;
    .locals 0
...
.method private z()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/w;->b:Landroidx/appcompat/widget/Y;

    iput-object v0, p0, Landroidx/appcompat/widget/w;->c:Landroidx/appcompat/widget/Y;

    iput-object v0, p0, Landroidx/appcompat/widget/w;->d:Landroidx/appcompat/widget/Y;

    iput-object v0, p0, Landroidx/appcompat/widget/w;->e:Landroidx/appcompat/widget/Y;

    iput-object v0, p0, Landroidx/appcompat/widget/w;->f:Landroidx/appcompat/widget/Y;

    iput-object v0, p0, Landroidx/appcompat/widget/w;->g:Landroidx/appcompat/widget/Y;
...
.method b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w;->b:Landroidx/appcompat/widget/Y;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w;->c:Landroidx/appcompat/widget/Y;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/w;->d:Landroidx/appcompat/widget/Y;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/w;->e:Landroidx/appcompat/widget/Y;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/w;->b:Landroidx/appcompat/widget/Y;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, Landroidx/appcompat/widget/w;->c:Landroidx/appcompat/widget/Y;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V

    aget-object v3, v0, v1

    iget-object v4, p0, Landroidx/appcompat/widget/w;->d:Landroidx/appcompat/widget/Y;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/w;->e:Landroidx/appcompat/widget/Y;

    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/w;->f:Landroidx/appcompat/widget/Y;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/w;->g:Landroidx/appcompat/widget/Y;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/w;->f:Landroidx/appcompat/widget/Y;

    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/w;->g:Landroidx/appcompat/widget/Y;

    invoke-direct {p0, v0, v1}, Landroidx/appcompat/widget/w;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Y;)V
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v10, v8, v2, v9, v12}, Landroidx/appcompat/widget/a0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/a0;
    ...
    invoke-static {v10, v11, v1}, Landroidx/appcompat/widget/w;->d(Landroid/content/Context;Landroidx/appcompat/widget/i;I)Landroidx/appcompat/widget/Y;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/w;->b:Landroidx/appcompat/widget/Y;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/w;->c:Landroidx/appcompat/widget/Y;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/w;->d:Landroidx/appcompat/widget/Y;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/w;->e:Landroidx/appcompat/widget/Y;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/w;->f:Landroidx/appcompat/widget/Y;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/w;->g:Landroidx/appcompat/widget/Y;
    ...
    sget-object v3, Lh/j;->B2:[I

    invoke-static {v10, v0, v3}, Landroidx/appcompat/widget/a0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/a0;
    ...
    invoke-virtual {v0, v3, v12}, Landroidx/appcompat/widget/a0;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v10, v0}, Landroidx/appcompat/widget/w;->C(Landroid/content/Context;Landroidx/appcompat/widget/a0;)V
    ...
    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/a0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v15, v12}, Landroidx/appcompat/widget/a0;->a(IZ)Z
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/a0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v14}, Landroidx/appcompat/widget/a0;->f(II)I
    ...
    invoke-virtual {v7, v3}, Landroidx/appcompat/widget/w;->s(Z)V
    ...
    invoke-static {v0, v6}, Landroidx/appcompat/widget/w$d;->d(Landroid/widget/TextView;Ljava/lang/String;)Z
    ...
    invoke-static {v5}, Landroidx/appcompat/widget/w$c;->a(Ljava/lang/String;)Landroid/os/LocaleList;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/appcompat/widget/w$c;->b(Landroid/widget/TextView;Landroid/os/LocaleList;)V
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/w$d;->a(Landroid/widget/TextView;)I
    ...
    invoke-static {v0, v1, v2, v3, v12}, Landroidx/appcompat/widget/w$d;->b(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {v1, v0, v12}, Landroidx/appcompat/widget/w$d;->c(Landroid/widget/TextView;[II)V
    ...
    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/a0;->n(II)I
    ...
    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/a0;->k(II)I

    move-result v0

    invoke-static {v0, v13}, Landroidx/appcompat/widget/I;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v8, v0, v14}, Landroidx/appcompat/widget/a0;->f(II)I

    move-result v0

    sget v1, Lh/j;->w0:I

    invoke-virtual {v8, v1, v14}, Landroidx/appcompat/widget/a0;->f(II)I

    move-result v1

    sget v2, Lh/j;->x0:I

    invoke-virtual {v8, v2}, Landroidx/appcompat/widget/a0;->s(I)Z

    move-result v3

    if-eqz v3, :cond_1e

    invoke-virtual {v8, v2}, Landroidx/appcompat/widget/a0;->w(I)Landroid/util/TypedValue;
    ...
    :cond_1d
    invoke-virtual {v8, v2, v14}, Landroidx/appcompat/widget/a0;->f(II)I
    ...
    invoke-static {v0, v2, v3}, Landroidx/core/widget/i;->n(Landroid/widget/TextView;IF)V
...
.method q(Landroid/content/Context;I)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/w;->C(Landroid/content/Context;Landroidx/appcompat/widget/a0;)V
    ...
    invoke-static {v0, p1}, Landroidx/appcompat/widget/w$d;->d(Landroid/widget/TextView;Ljava/lang/String;)Z
...
.method r(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1}, Lu1/a;->e(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;)V
