...
.field private static final j:Landroidx/appcompat/widget/S$a;


# instance fields
.field private a:Ljava/util/WeakHashMap;

.field private b:Landroidx/collection/S;

.field private c:Landroidx/collection/T;
...
.field private g:Landroidx/appcompat/widget/S$c;
...
.method private declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Landroidx/collection/t;->k(JLjava/lang/Object;)V
    :try_end_0
...
.method private b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    :cond_1
    invoke-virtual {v0, p2, p3}, Landroidx/collection/T;->b(ILjava/lang/Object;)V
...
.method private e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v1, v2}, Landroidx/appcompat/widget/S;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/S$c;->a(Landroidx/appcompat/widget/S;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/S;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private declared-synchronized h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Landroidx/collection/t;->g(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Landroidx/collection/t;->l(J)V
    :try_end_2
...
.method private m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2}, Landroidx/collection/T;->h(I)Ljava/lang/Object;
...
.method private static o(Landroidx/appcompat/widget/S;)V
    .locals 0
...
.method private q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/S;->b:Landroidx/collection/S;

    const/4 v1, 0x0

    if-eqz v0, :cond_a

    invoke-virtual {v0}, Landroidx/collection/S;->isEmpty()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p0, Landroidx/appcompat/widget/S;->c:Landroidx/collection/T;

    const-string v2, "appcompat_skip_skip"

    if-eqz v0, :cond_1

    invoke-virtual {v0, p2}, Landroidx/collection/T;->h(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/S;->b:Landroidx/collection/S;

    invoke-virtual {v3, v0}, Landroidx/collection/S;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/S;->c:Landroidx/collection/T;
    ...
    invoke-direct {p0, p1, v4, v5}, Landroidx/appcompat/widget/S;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/S;->c:Landroidx/collection/T;

    invoke-virtual {v8, p2, v3}, Landroidx/collection/T;->b(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/S;->b:Landroidx/collection/S;

    invoke-virtual {v8, v3}, Landroidx/collection/S;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/S;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/S;->c:Landroidx/collection/T;

    invoke-virtual {p1, p2, v2}, Landroidx/collection/T;->b(ILjava/lang/Object;)V
...
.method declared-synchronized j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/S;->c(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/S;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/S;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/S;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/S;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/S$c;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/appcompat/widget/S;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/S$c;->d(I)Landroid/graphics/PorterDuff$Mode;
...
.method declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/g0;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-direct {p0, p1, p3}, Landroidx/appcompat/widget/S;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/S;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {v0, p1, p2, p3}, Landroidx/appcompat/widget/S$c;->c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
