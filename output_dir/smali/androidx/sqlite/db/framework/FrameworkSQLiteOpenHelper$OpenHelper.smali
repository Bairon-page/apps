...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Lg2/h$a;Z)V
    .locals 7
    ...
    iget v5, p4, Lg2/h$a;->a:I

    new-instance v6, Landroidx/sqlite/db/framework/a;

    invoke-direct {v6, p4, p3}, Landroidx/sqlite/db/framework/a;-><init>(Lg2/h$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;)V
    ...
    iput-object p4, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->c:Lg2/h$a;
    ...
    invoke-direct {p3, p2, p1, p4}, Li2/a;-><init>(Ljava/lang/String;Ljava/io/File;Z)V

    iput-object p3, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f:Li2/a;
...
.method private final C(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->w(Z)Landroid/database/sqlite/SQLiteDatabase;
...
.method public static synthetic a(Lg2/h$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->d(Lg2/h$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V

    return-void
.end method

.method private static final d(Lg2/h$a;Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$b;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lg2/h$a;->c(Lg2/g;)V

    return-void
.end method

.method private final w(Z)Landroid/database/sqlite/SQLiteDatabase;
    .locals 1
...
.method public close()V
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f:Li2/a;
    ...
    invoke-static {v0, v3, v1, v2}, Li2/a;->c(Li2/a;ZILjava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f:Li2/a;
...
.method public final f(Z)Lg2/g;
    ...
    invoke-direct {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->C(Z)Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->f(Z)Lg2/g;
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, v0}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->t(Landroid/database/sqlite/SQLiteDatabase;)Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;
...
.method public onConfigure(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    iget-object v0, p0, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->c:Lg2/h$a;

    iget v0, v0, Lg2/h$a;->a:I
    ...
    invoke-virtual {p0, p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteOpenHelper$OpenHelper;->t(Landroid/database/sqlite/SQLiteDatabase;)Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;

    move-result-object p1

    invoke-virtual {v0, p1}, Lg2/h$a;->b(Lg2/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, p1}, Lg2/h$a;->d(Lg2/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onDowngrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lg2/h$a;->e(Lg2/g;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-virtual {v0, p1}, Lg2/h$a;->f(Lg2/g;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lg2/h$a;->g(Lg2/g;II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final t(Landroid/database/sqlite/SQLiteDatabase;)Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;
    .locals 2
