...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/b;Lz2/b;Landroidx/work/impl/WorkDatabase;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/work/impl/u;->d:Lz2/b;
...
.method public static synthetic b(Landroidx/work/impl/u;Ljava/util/ArrayList;Ljava/lang/String;)Lx2/u;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/work/impl/u;->m(Ljava/util/ArrayList;Ljava/lang/String;)Lx2/u;
...
.method public static synthetic c(Landroidx/work/impl/u;Lx2/m;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/work/impl/u;->l(Lx2/m;Z)V

    return-void
.end method

.method public static synthetic d(Landroidx/work/impl/u;Lcom/google/common/util/concurrent/f;Landroidx/work/impl/T;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/work/impl/u;->n(Lcom/google/common/util/concurrent/f;Landroidx/work/impl/T;)V

    return-void
.end method

.method private f(Ljava/lang/String;)Landroidx/work/impl/T;
    .locals 3
...
.method private h(Ljava/lang/String;)Landroidx/work/impl/T;
    .locals 1
...
.method private static i(Ljava/lang/String;Landroidx/work/impl/T;I)Z
    .locals 2

    if-eqz p1, :cond_0

    invoke-virtual {p1, p2}, Landroidx/work/impl/T;->g(I)V
...
.method private synthetic l(Lx2/m;Z)V
    .locals 3
    ...
    invoke-interface {v2, p1, p2}, Landroidx/work/impl/f;->a(Lx2/m;Z)V
...
.method private synthetic m(Ljava/util/ArrayList;Ljava/lang/String;)Lx2/u;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/u;->e:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->j()Lx2/z;

    move-result-object v0

    invoke-interface {v0, p2}, Lx2/z;->b(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-interface {p1, p2}, Lx2/v;->i(Ljava/lang/String;)Lx2/u;
...
.method private synthetic n(Lcom/google/common/util/concurrent/f;Landroidx/work/impl/T;)V
    .locals 0
    ...
    :goto_0
    invoke-direct {p0, p2, p1}, Landroidx/work/impl/u;->o(Landroidx/work/impl/T;Z)V

    return-void
.end method

.method private o(Landroidx/work/impl/T;Z)V
    .locals 6
    ...
    :try_start_0
    invoke-virtual {p1}, Landroidx/work/impl/T;->d()Lx2/m;
    ...
    invoke-direct {p0, v2}, Landroidx/work/impl/u;->h(Ljava/lang/String;)Landroidx/work/impl/T;

    move-result-object v3

    if-ne v3, p1, :cond_0

    invoke-direct {p0, v2}, Landroidx/work/impl/u;->f(Ljava/lang/String;)Landroidx/work/impl/T;
    ...
    invoke-interface {v2, v1, p2}, Landroidx/work/impl/f;->a(Lx2/m;Z)V
...
.method private q(Lx2/m;Z)V
    .locals 2

    iget-object v0, p0, Landroidx/work/impl/u;->d:Lz2/b;
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/work/impl/t;-><init>(Landroidx/work/impl/u;Lx2/m;Z)V
...
.method public a(Ljava/lang/String;Landroidx/work/h;)V
    ...
    invoke-static {v2, v3}, Ly2/w;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/T;->d()Lx2/m;

    move-result-object v1

    invoke-static {p1, v1, p2}, Landroidx/work/impl/foreground/b;->f(Landroid/content/Context;Lx2/m;Landroidx/work/h;)Landroid/content/Intent;
...
.method public g(Ljava/lang/String;)Lx2/u;
    .locals 1
    ...
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/work/impl/u;->h(Ljava/lang/String;)Landroidx/work/impl/T;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroidx/work/impl/T;->e()Lx2/u;
...
.method public s(Landroidx/work/impl/A;Landroidx/work/WorkerParameters$a;)Z
    ...
    invoke-virtual {p1}, Landroidx/work/impl/A;->a()Lx2/m;
    ...
    invoke-direct {p0, v0, v2}, Landroidx/work/impl/u;->q(Lx2/m;Z)V
    ...
    invoke-virtual {v1}, Landroidx/work/impl/A;->a()Lx2/m;

    move-result-object v1

    invoke-virtual {v1}, Lx2/m;->a()I

    move-result v1

    invoke-virtual {v0}, Lx2/m;->a()I
    ...
    :cond_3
    new-instance v11, Landroidx/work/impl/T$c;
    ...
    iget-object v5, p0, Landroidx/work/impl/u;->d:Lz2/b;
    ...
    invoke-direct/range {v2 .. v9}, Landroidx/work/impl/T$c;-><init>(Landroid/content/Context;Landroidx/work/b;Lz2/b;Landroidx/work/impl/foreground/a;Landroidx/work/impl/WorkDatabase;Lx2/u;Ljava/util/List;)V

    invoke-virtual {v11, p2}, Landroidx/work/impl/T$c;->c(Landroidx/work/WorkerParameters$a;)Landroidx/work/impl/T$c;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/work/impl/T$c;->b()Landroidx/work/impl/T;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/work/impl/T;->c()Lcom/google/common/util/concurrent/f;

    move-result-object v2

    new-instance v3, Landroidx/work/impl/s;

    invoke-direct {v3, p0, v2, p2}, Landroidx/work/impl/s;-><init>(Landroidx/work/impl/u;Lcom/google/common/util/concurrent/f;Landroidx/work/impl/T;)V

    iget-object v4, p0, Landroidx/work/impl/u;->d:Lz2/b;

    invoke-interface {v4}, Lz2/b;->a()Ljava/util/concurrent/Executor;
    ...
    iget-object p1, p0, Landroidx/work/impl/u;->d:Lz2/b;

    invoke-interface {p1}, Lz2/b;->c()Lz2/a;
...
.method public t(Ljava/lang/String;I)Z
    ...
    invoke-direct {p0, p1}, Landroidx/work/impl/u;->f(Ljava/lang/String;)Landroidx/work/impl/T;
    ...
    invoke-static {p1, v1, p2}, Landroidx/work/impl/u;->i(Ljava/lang/String;Landroidx/work/impl/T;I)Z
...
.method public w(Landroidx/work/impl/A;I)Z
    ...
    :cond_1
    invoke-direct {p0, v0}, Landroidx/work/impl/u;->f(Ljava/lang/String;)Landroidx/work/impl/T;
    ...
    invoke-static {v0, p1, p2}, Landroidx/work/impl/u;->i(Ljava/lang/String;Landroidx/work/impl/T;I)Z
