...
.method constructor <init>(Lx2/w;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lx2/w$i;->a:Lx2/w;
...
.method public bridge synthetic bind(Lg2/k;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lx2/w$i;->d(Lg2/k;Lx2/u;)V
...
.method public d(Lg2/k;Lx2/u;)V
    ...
    iget-object p2, p2, Lx2/u;->j:Landroidx/work/d;
    ...
    invoke-static {v8}, Lx2/B;->g(Landroidx/work/NetworkType;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, Lg2/i;->N0(IJ)V
    ...
    invoke-interface {p1, v5, v8, v9}, Lg2/i;->N0(IJ)V
    ...
    invoke-static {p2}, Lx2/B;->i(Ljava/util/Set;)[B
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Lg2/i;->S0(I[B)V
