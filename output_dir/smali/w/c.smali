...
.method private static final a(IIZ)I
    ...
    invoke-static {p0, p1, p2}, Lw/c;->f(IIZ)I
...
.method public static final b(IIIZ)I
    ...
    invoke-static {p1, p2, p3}, Lw/c;->f(IIZ)I
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lw/c;->g(IIIZ)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0, p1, p3}, Lw/c;->e(IIZ)I
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3}, Lw/c;->h(IIIZ)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0, p1, p3}, Lw/c;->d(IIZ)I
    ...
    :cond_2
    invoke-static {p1, p2, p3}, Lw/c;->a(IIZ)I
...
.method public static synthetic c(IIIZILjava/lang/Object;)I
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lw/c;->b(IIIZ)I
...
.method private static final d(IIZ)I
    ...
    invoke-static {p0, p1, p2}, Lw/c;->e(IIZ)I
