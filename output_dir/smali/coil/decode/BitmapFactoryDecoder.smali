...
.method public constructor <init>(Lcoil/decode/e;LM2/k;Lyh/c;Lcoil/decode/ExifOrientationPolicy;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcoil/decode/BitmapFactoryDecoder;->a:Lcoil/decode/e;

    iput-object p2, p0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    iput-object p3, p0, Lcoil/decode/BitmapFactoryDecoder;->c:Lyh/c;
...
.method public static final synthetic b(Lcoil/decode/BitmapFactoryDecoder;Landroid/graphics/BitmapFactory$Options;)LF2/a;
    .locals 0

    invoke-direct {p0, p1}, Lcoil/decode/BitmapFactoryDecoder;->e(Landroid/graphics/BitmapFactory$Options;)LF2/a;
...
.method private final c(Landroid/graphics/BitmapFactory$Options;LF2/c;)V
    .locals 2

    iget-object v0, p0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v0}, LM2/k;->f()Landroid/graphics/Bitmap$Config;
    ...
    :cond_0
    invoke-static {v0}, LR2/a;->e(Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap$Config;

    move-result-object v0

    :cond_1
    iget-object p2, p0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {p2}, LM2/k;->d()Z
...
.method private final d(Landroid/graphics/BitmapFactory$Options;LF2/c;)V
    .locals 22
    ...
    iget-object v2, v0, Lcoil/decode/BitmapFactoryDecoder;->a:Lcoil/decode/e;

    invoke-virtual {v2}, Lcoil/decode/e;->a()Lcoil/decode/e$a;

    move-result-object v2

    instance-of v3, v2, Lcoil/decode/f;

    const/4 v4, 0x1

    if-eqz v3, :cond_0

    iget-object v3, v0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v3}, LM2/k;->o()Lcoil/size/e;

    move-result-object v3

    invoke-static {v3}, Lcoil/size/b;->a(Lcoil/size/e;)Z
    ...
    invoke-virtual {v2}, Lcoil/decode/f;->a()I

    move-result v2

    iput v2, v1, Landroid/graphics/BitmapFactory$Options;->inDensity:I

    iget-object v2, v0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;
    ...
    :cond_1
    invoke-static/range {p2 .. p2}, LF2/f;->b(LF2/c;)Z
    ...
    :goto_1
    iget-object v6, v0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v6}, LM2/k;->o()Lcoil/size/e;

    move-result-object v6

    iget-object v7, v0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v7}, LM2/k;->n()Lcoil/size/Scale;

    move-result-object v7

    invoke-static {v6}, Lcoil/size/b;->a(Lcoil/size/e;)Z
    ...
    :cond_4
    invoke-virtual {v6}, Lcoil/size/e;->d()Lcoil/size/c;

    move-result-object v6

    invoke-static {v6, v7}, LR2/j;->A(Lcoil/size/c;Lcoil/size/Scale;)I
    ...
    invoke-virtual {v7}, LM2/k;->o()Lcoil/size/e;

    move-result-object v7

    iget-object v8, v0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v8}, LM2/k;->n()Lcoil/size/Scale;

    move-result-object v8

    invoke-static {v7}, Lcoil/size/b;->a(Lcoil/size/e;)Z
    ...
    :cond_5
    invoke-virtual {v7}, Lcoil/size/e;->c()Lcoil/size/c;

    move-result-object v7

    invoke-static {v7, v8}, LR2/j;->A(Lcoil/size/c;Lcoil/size/Scale;)I
    ...
    invoke-static {v2, v5, v6, v7, v8}, LF2/b;->a(IIIILcoil/size/Scale;)I
    ...
    invoke-virtual {v2}, LM2/k;->n()Lcoil/size/Scale;
    ...
    invoke-static/range {v13 .. v21}, LF2/b;->b(DDDDLcoil/size/Scale;)D
    ...
    invoke-static {v5, v6, v7, v8}, Lfg/j;->f(DD)D
    ...
    invoke-static {v7, v8}, Lbg/a;->c(D)I
    ...
    invoke-static {v2, v3}, Lbg/a;->c(D)I
...
.method private final e(Landroid/graphics/BitmapFactory$Options;)LF2/a;
    .locals 8

    new-instance v0, Lcoil/decode/BitmapFactoryDecoder$b;

    iget-object v1, p0, Lcoil/decode/BitmapFactoryDecoder;->a:Lcoil/decode/e;

    invoke-virtual {v1}, Lcoil/decode/e;->d()LSh/f;

    move-result-object v1

    invoke-direct {v0, v1}, Lcoil/decode/BitmapFactoryDecoder$b;-><init>(LSh/H;)V
    ...
    invoke-interface {v1}, LSh/f;->peek()LSh/f;

    move-result-object v3

    invoke-interface {v3}, LSh/f;->q1()Ljava/io/InputStream;
    ...
    invoke-virtual {v5, v6, v1, v7}, LF2/e;->a(Ljava/lang/String;LSh/f;Lcoil/decode/ExifOrientationPolicy;)LF2/c;
    ...
    iget-object v7, p0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v7}, LM2/k;->e()Landroid/graphics/ColorSpace;
    ...
    invoke-virtual {v7}, LM2/k;->m()Z

    move-result v7

    iput-boolean v7, p1, Landroid/graphics/BitmapFactory$Options;->inPremultiplied:Z

    invoke-direct {p0, p1, v6}, Lcoil/decode/BitmapFactoryDecoder;->c(Landroid/graphics/BitmapFactory$Options;LF2/c;)V

    invoke-direct {p0, p1, v6}, Lcoil/decode/BitmapFactoryDecoder;->d(Landroid/graphics/BitmapFactory$Options;LF2/c;)V

    :try_start_0
    invoke-interface {v1}, LSh/f;->q1()Ljava/io/InputStream;
    ...
    invoke-static {v1, v4}, LWf/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v5, v7, v6}, LF2/e;->b(Landroid/graphics/Bitmap;LF2/c;)Landroid/graphics/Bitmap;

    move-result-object v0

    new-instance v1, LF2/a;

    iget-object v4, p0, Lcoil/decode/BitmapFactoryDecoder;->b:LM2/k;

    invoke-virtual {v4}, LM2/k;->g()Landroid/content/Context;
    ...
    :cond_2
    :goto_0
    invoke-direct {v1, v5, v2}, LF2/a;-><init>(Landroid/graphics/drawable/Drawable;Z)V
    ...
    invoke-static {v1, p1}, LWf/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public a(LRf/c;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Lcoil/decode/BitmapFactoryDecoder$decode$1;-><init>(Lcoil/decode/BitmapFactoryDecoder;LRf/c;)V
    ...
    iget-object p1, p0, Lcoil/decode/BitmapFactoryDecoder;->c:Lyh/c;
    ...
    invoke-interface {p1, v0}, Lyh/c;->a(LRf/c;)Ljava/lang/Object;
    ...
    invoke-static {v5, v2, v0, v4, v5}, Lkotlinx/coroutines/InterruptibleKt;->c(Lkotlin/coroutines/d;LZf/a;LRf/c;ILjava/lang/Object;)Ljava/lang/Object;
