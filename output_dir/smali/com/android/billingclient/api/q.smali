...
# direct methods
.method synthetic constructor <init>(Lcom/android/billingclient/api/b;Lt3/e;Lt3/p;)V
    .locals 0

    iput-object p1, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;
    ...
    iput-object p2, p0, Lcom/android/billingclient/api/q;->c:Lt3/e;
...
.method private final d(Lcom/android/billingclient/api/d;)V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/billingclient/api/q;->c:Lt3/e;

    if-eqz v1, :cond_0

    invoke-interface {v1, p1}, Lt3/e;->onBillingSetupFinished(Lcom/android/billingclient/api/d;)V
...
.method final synthetic a()Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v5, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;
    ...
    :try_start_2
    iget-object v9, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v9}, Lcom/android/billingclient/api/b;->T(Lcom/android/billingclient/api/b;)Lcom/google/android/gms/internal/play_billing/zzm;
    ...
    iget-object v12, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v12}, Lcom/android/billingclient/api/b;->T(Lcom/android/billingclient/api/b;)Lcom/google/android/gms/internal/play_billing/zzm;
    ...
    iget-object v0, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v0, v10}, Lcom/android/billingclient/api/b;->a0(Lcom/android/billingclient/api/b;I)V

    const-string v0, "BillingClient"

    iget-object v5, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v5}, Lcom/android/billingclient/api/b;->G(Lcom/android/billingclient/api/b;)I
    ...
    :goto_10
    invoke-static {v0, v5}, Lcom/android/billingclient/api/b;->e0(Lcom/android/billingclient/api/b;Z)V
    ...
    :goto_11
    invoke-static {v0, v5}, Lcom/android/billingclient/api/b;->d0(Lcom/android/billingclient/api/b;Z)V
    ...
    :goto_12
    invoke-static {v0, v5}, Lcom/android/billingclient/api/b;->c0(Lcom/android/billingclient/api/b;Z)V
    ...
    :goto_13
    invoke-static {v0, v5}, Lcom/android/billingclient/api/b;->b0(Lcom/android/billingclient/api/b;Z)V
    ...
    invoke-static {v0, v3}, Lcom/android/billingclient/api/b;->Z(Lcom/android/billingclient/api/b;I)V

    iget-object v0, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v0}, Lcom/android/billingclient/api/b;->Q(Lcom/android/billingclient/api/b;)Lcom/android/billingclient/api/H;
    ...
    iget-object v3, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;
    ...
    invoke-virtual {v0, v4}, Lcom/android/billingclient/api/H;->f(Z)V
    ...
    invoke-static {v0, v4}, Lcom/android/billingclient/api/b;->Z(Lcom/android/billingclient/api/b;I)V

    iget-object v0, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    invoke-static {v0, v2}, Lcom/android/billingclient/api/b;->v(Lcom/android/billingclient/api/b;Lcom/google/android/gms/internal/play_billing/zzm;)V
    :try_end_2
    ...
    invoke-static {v0}, Lcom/android/billingclient/api/b;->R(Lcom/android/billingclient/api/b;)Lcom/android/billingclient/api/s;
    ...
    invoke-direct {p0, v0}, Lcom/android/billingclient/api/q;->d(Lcom/android/billingclient/api/d;)V
    ...
    sget-object v3, Lcom/android/billingclient/api/t;->a:Lcom/android/billingclient/api/d;

    invoke-static {v7, v1, v3}, Lt3/y;->a(IILcom/android/billingclient/api/d;)Lcom/google/android/gms/internal/play_billing/zzhy;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/android/billingclient/api/s;->a(Lcom/google/android/gms/internal/play_billing/zzhy;)V

    invoke-direct {p0, v3}, Lcom/android/billingclient/api/q;->d(Lcom/android/billingclient/api/d;)V
...
.method final synthetic b()V
    ...
    invoke-static {v0, v1}, Lcom/android/billingclient/api/b;->Z(Lcom/android/billingclient/api/b;I)V

    iget-object v0, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lcom/android/billingclient/api/b;->v(Lcom/android/billingclient/api/b;Lcom/google/android/gms/internal/play_billing/zzm;)V
    ...
    invoke-direct {p0, v1}, Lcom/android/billingclient/api/q;->d(Lcom/android/billingclient/api/d;)V
...
.method final c()V
    ...
    :try_start_0
    iput-object v1, p0, Lcom/android/billingclient/api/q;->c:Lt3/e;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-object p1, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;
    ...
    invoke-static {p1, p2}, Lcom/android/billingclient/api/b;->v(Lcom/android/billingclient/api/b;Lcom/google/android/gms/internal/play_billing/zzm;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/billingclient/api/b;->Y(Lcom/android/billingclient/api/b;Ljava/util/concurrent/Callable;JLjava/lang/Runnable;Landroid/os/Handler;)Ljava/util/concurrent/Future;
    ...
    invoke-static {p1}, Lcom/android/billingclient/api/b;->R(Lcom/android/billingclient/api/b;)Lcom/android/billingclient/api/s;
    ...
    invoke-static {v0, v1, p2}, Lt3/y;->a(IILcom/android/billingclient/api/d;)Lcom/google/android/gms/internal/play_billing/zzhy;

    move-result-object v0

    invoke-interface {p1, v0}, Lcom/android/billingclient/api/s;->a(Lcom/google/android/gms/internal/play_billing/zzhy;)V

    invoke-direct {p0, p2}, Lcom/android/billingclient/api/q;->d(Lcom/android/billingclient/api/d;)V
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    invoke-interface {p1, v0}, Lcom/android/billingclient/api/s;->b(Lcom/google/android/gms/internal/play_billing/zziz;)V

    iget-object p1, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lcom/android/billingclient/api/b;->v(Lcom/android/billingclient/api/b;Lcom/google/android/gms/internal/play_billing/zzm;)V

    iget-object p1, p0, Lcom/android/billingclient/api/q;->d:Lcom/android/billingclient/api/b;

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lcom/android/billingclient/api/b;->Z(Lcom/android/billingclient/api/b;I)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/billingclient/api/q;->c:Lt3/e;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lt3/e;->onBillingServiceDisconnected()V
