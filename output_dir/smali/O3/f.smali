...
.method private final c()V
    ...
    sget-object v0, LO3/h;->s:LO3/h$b;

    invoke-virtual {v0}, LO3/h$b;->d()Ljava/util/Map;

    move-result-object v1

    invoke-virtual {v0}, LO3/h$b;->e()Ljava/util/Map;

    move-result-object v2

    invoke-static {v1, v2}, LO3/j;->e(Ljava/util/Map;Ljava/util/Map;)V
...
.method public static final d(Landroid/content/Context;)V
    ...
    :cond_1
    sget-object v1, LO3/h;->s:LO3/h$b;

    invoke-virtual {v1, p0}, LO3/h$b;->c(Landroid/content/Context;)LO3/h;
    ...
    :cond_2
    invoke-virtual {v1}, LO3/h$b;->f()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {p0, v2, v1}, LO3/h;->p(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, v2, v1}, LO3/h;->o(Ljava/lang/String;Ljava/lang/Runnable;)V
    :try_end_1
