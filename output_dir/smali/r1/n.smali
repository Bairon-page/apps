...
.method private constructor <init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    .line 8
    iput-object p1, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private C()Z
    ...
    invoke-direct {p0, v0}, Lr1/n;->f(Ljava/lang/String;)Ljava/util/List;
...
.method public static U()Lr1/n;
    ...
    invoke-static {v0}, Lr1/n;->W0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lr1/n;
...
.method public static V(Landroid/view/View;)Lr1/n;
    .locals 0
    ...
    invoke-static {p0}, Lr1/n;->W0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lr1/n;
...
.method public static W(Lr1/n;)Lr1/n;
    .locals 0

    iget-object p0, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public static W0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lr1/n;
    .locals 1

    new-instance v0, Lr1/n;

    invoke-direct {v0, p0}, Lr1/n;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    return-object v0
.end method

.method static X0(Ljava/lang/Object;)Lr1/n;
    .locals 1
...
.method private f(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v0, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-object v1, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method private j(I)Z
    ...
    invoke-virtual {p0}, Lr1/n;->t()Landroid/os/Bundle;
...
.method public A()Ljava/lang/String;
    ...
    invoke-static {v0}, Lr1/n$c;->g(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/String;
...
.method public D()Z
    ...
    invoke-static {v0}, Lr1/n$d;->f(Landroid/view/accessibility/AccessibilityNodeInfo;)Z
    ...
    invoke-direct {p0, v0}, Lr1/n;->j(I)Z
...
.method public F0(Lr1/n$g;)V
    .locals 1

    iget-object v0, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    iget-object p1, p1, Lr1/n$g;->a:Ljava/lang/Object;
...
.method public M0(Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0, p1}, Lr1/n$b;->c(Landroid/view/accessibility/AccessibilityNodeInfo;Ljava/lang/CharSequence;)V
...
.method public S()Z
    ...
    invoke-static {v0}, Lr1/n$c;->h(Landroid/view/accessibility/AccessibilityNodeInfo;)Z
...
.method public Z(Lr1/n$a;)Z
    .locals 1

    iget-object v0, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    iget-object p1, p1, Lr1/n$a;->a:Ljava/lang/Object;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    if-nez v2, :cond_3

    iget-object v2, p1, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    iget-object v3, p1, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_4
    iget v2, p0, Lr1/n;->c:I

    iget v3, p1, Lr1/n;->c:I
...
.method public g()Ljava/util/List;
    ...
    invoke-direct {v5, v4}, Lr1/n$a;-><init>(Ljava/lang/Object;)V
...
.method public i0(Ljava/lang/Object;)V
    ...
    :cond_0
    check-cast p1, Lr1/n$e;

    iget-object p1, p1, Lr1/n$e;->a:Ljava/lang/Object;
...
.method public j0(Ljava/lang/Object;)V
    ...
    :cond_0
    check-cast p1, Lr1/n$f;

    iget-object p1, p1, Lr1/n$f;->a:Ljava/lang/Object;
...
.method public m(Landroid/graphics/Rect;)V
    ...
    invoke-static {v0, p1}, Lr1/n$d;->b(Landroid/view/accessibility/AccessibilityNodeInfo;Landroid/graphics/Rect;)V
...
.method public q()Ljava/lang/CharSequence;
    ...
    invoke-static {v0}, Lr1/n$d;->c(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lr1/n;->k(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v1}, Lr1/n;->l(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v1}, Lr1/n;->m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0}, Lr1/n;->w()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->o()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->y()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->s()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->x()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->r()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->z()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->A()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lr1/n;->q()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lr1/n;->g()Ljava/util/List;
    ...
    check-cast v3, Lr1/n$a;

    invoke-virtual {v3}, Lr1/n$a;->b()I

    move-result v4

    invoke-static {v4}, Lr1/n;->h(I)Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lr1/n$a;->c()Ljava/lang/CharSequence;
...
.method public x()Ljava/lang/CharSequence;
    ...
    invoke-static {v0}, Lr1/n$b;->b(Landroid/view/accessibility/AccessibilityNodeInfo;)Ljava/lang/CharSequence;
...
.method public y()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v1}, Lr1/n;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v1

    const-string v2, "androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY"

    invoke-direct {p0, v2}, Lr1/n;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v2

    const-string v3, "androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY"

    invoke-direct {p0, v3}, Lr1/n;->f(Ljava/lang/String;)Ljava/util/List;

    move-result-object v3

    new-instance v4, Landroid/text/SpannableString;

    iget-object v5, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v5}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object v5

    iget-object v6, p0, Lr1/n;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {v5, v6, p0, v8}, Lr1/a;-><init>(ILr1/n;I)V
