...
.method private d(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lk4/c;)Lk4/a$a;
    .locals 16

    move-object/from16 v0, p2

    invoke-direct/range {p0 .. p1}, Lk4/a;->f(Landroid/content/Context;)[Ljava/lang/String;
    ...
    invoke-virtual {v15, v13, v14}, Lk4/c;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v5, v12}, Lk4/a$a;-><init>(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;)V
...
.method private e(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lk4/a;->f(Landroid/content/Context;)[Ljava/lang/String;
...
# virtual methods
.method public a(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Ljava/io/File;Lk4/c;)V
    .locals 8

    const/4 v0, 0x0

    :try_start_0
    invoke-direct {p0, p1, p2, p3, p5}, Lk4/a;->d(Landroid/content/Context;[Ljava/lang/String;Ljava/lang/String;Lk4/c;)Lk4/a$a;
    ...
    invoke-virtual {p5, p2, v3}, Lk4/c;->i(Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_1
    ...
    :cond_0
    :try_start_3
    iget-object p2, v1, Lk4/a$a;->a:Ljava/util/zip/ZipFile;

    iget-object v3, v1, Lk4/a$a;->b:Ljava/util/zip/ZipEntry;
    ...
    :try_start_5
    invoke-direct {p0, p2, v3}, Lk4/a;->c(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    :try_start_6
    invoke-direct {p0, p2}, Lk4/a;->b(Ljava/io/Closeable;)V

    :goto_1
    invoke-direct {p0, v3}, Lk4/a;->b(Ljava/io/Closeable;)V
    ...
    :try_start_7
    iget-object p1, v1, Lk4/a$a;->a:Ljava/util/zip/ZipFile;
    ...
    :goto_3
    :try_start_8
    invoke-direct {p0, v0}, Lk4/a;->b(Ljava/io/Closeable;)V
    ...
    invoke-virtual {p5, p1}, Lk4/c;->h(Ljava/lang/String;)V
    :try_end_8
    ...
    :cond_5
    :try_start_a
    invoke-direct {p0, p1, p3}, Lk4/a;->e(Landroid/content/Context;Ljava/lang/String;)[Ljava/lang/String;
    ...
    :try_start_c
    iget-object p2, v0, Lk4/a$a;->a:Ljava/util/zip/ZipFile;
