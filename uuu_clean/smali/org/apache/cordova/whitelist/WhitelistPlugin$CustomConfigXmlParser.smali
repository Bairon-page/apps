...
.method public handleStartTag(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 75
    :cond_1
    const-string/jumbo v7, "allow-navigation"
    ...
    :cond_3
    const-string/jumbo v7, "allow-intent"
    ...
    .line 89
    .restart local v1    # "origin":Ljava/lang/String;
    const-string/jumbo v7, "subdomains"
    ...
    const-string/jumbo v7, "launch-external"
    ...
    .line 93
    const-string/jumbo v7, "WhitelistPlugin"

    const-string/jumbo v8, "Found <access launch-external> within config.xml. Please use <allow-intent> instead."
